...
{
	public static class MaterialExtension // TypeDefIndex: 37510
	{
		// Extension methods
		public static SurfaceType GetSurfaceType(this Material material) => default; // 0x0000000189B3EE4C-0x0000000189B3EE94
		...
		public static MaterialId GetMaterialId(this Material material) => default; // 0x0000000189B3EDB4-0x0000000189B3EE00
		...
		public static HG.Rendering.Editor.BlendMode GetBlendMode(this Material material) => default; // 0x0000000189B3ED1C-0x0000000189B3ED68
		...
		public static int GetLayerCount(this Material material) => default; // 0x0000000189B3ED68-0x0000000189B3EDB4
		...
		public static bool GetZWrite(this Material material) => default; // 0x0000000189B3EF78-0x0000000189B3EFC4
		...
		public static bool GetTransparentZWrite(this Material material) => default; // 0x0000000189B3EF2C-0x0000000189B3EF78
		...
		public static CullMode GetTransparentCullMode(this Material material) => default; // 0x0000000189B3EE94-0x0000000189B3EEE0
		...
		public static CullMode GetOpaqueCullMode(this Material material) => default; // 0x0000000189B3EE00-0x0000000189B3EE4C
		...
		public static CompareFunction GetTransparentZTest(this Material material) => default; // 0x0000000189B3EEE0-0x0000000189B3EF2C
		...
		public static void ResetMaterialCustomRenderQueue(this Material material) {} // 0x0000000189B3EFC4-0x0000000189B3F198
		...
		LABEL_18:
		  ...
		  {
		    v16 = sub_18007E180(&TypeInfo::System::ArgumentException);
		    v17 = (InvalidEnumArgumentException *)sub_18002C620(v16);
		    if ( v17 )
		    {
		      v18 = (String *)sub_18007E180(&off_18E25BB80);
		      System::ComponentModel::InvalidEnumArgumentException::InvalidEnumArgumentException(v17, v18, 0LL);
		      v19 = sub_18007E180(&MethodInfo::HG::Rendering::Editor::MaterialExtension::ResetMaterialCustomRenderQueue);
		...
		public static void UpdateEmissiveColorFromIntensityAndEmissiveColorLDR(this Material material) {} // 0x0000000189B3F198-0x0000000189B3F2B4
