...
namespace HG.Rendering.Runtime
{
	...
	internal struct TerrainDeformConstData
	{
		public void SetConstData(HGTerrainDeformManager deformManager)
		{
			...
			//     if ( Patch )
			//     {
			//       IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_1031(Patch, this, (Object *)deformManager, 0LL);
			//       return;
			//     }
			// LABEL_7:
			//     sub_180B536AC(v6, v5);
