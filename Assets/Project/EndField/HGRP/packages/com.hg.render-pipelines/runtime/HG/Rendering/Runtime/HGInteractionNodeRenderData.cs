...
{
	public struct HGInteractionNodeRenderData // TypeDefIndex: 37751
	{
		// Fields
		public HGInteractionNodeInstanceData instanceData; // 0x00
		public Mesh mesh; // 0xE0
		public int passIndex; // 0xE8
		public bool ccdKeyword; // 0xEC
	
		// Methods
		public static int Sorter(HGInteractionNodeRenderData a, HGInteractionNodeRenderData b) => default; // 0x0000000189CFE810-0x0000000189CFEFA0
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1809, 0LL) )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(1809, 0LL);
		    if ( Patch )
		    {
		      ...
		      *(_OWORD *)&v199.mesh = v197;
		      return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_729(Patch, &v199, &v198, 0LL);
		    }
		LABEL_12:
		    sub_1800D8260(Patch, v33);
		  }
		...
		public bool Match([IsReadOnly] in HGInteractionNodeRenderData other) => default; // 0x0000000182D310C0-0x0000000182D312A0
		// Boolean Match(HGInteractionNodeRenderData ByRef)
		        ...
		        MethodInfo *method)
		{
		  ...
		  struct Object_1__Class *wrapperArray; // rdx
		  Mesh *mesh; // rbx
		  Mesh *v9; // rdi
		  bool v10; // zf
		  ...
		  wrapperArray = (struct Object_1__Class *)v5->static_fields->wrapperArray;
		  if ( !wrapperArray )
		    goto LABEL_34;
		  if ( SLODWORD(wrapperArray->_0.namespaze) > 1810 )
		  {
		    ...
		    if ( !wrapperArray )
		      goto LABEL_34;
		    if ( LODWORD(wrapperArray->_0.namespaze) <= 0x712 )
		      goto LABEL_35;
		    if ( *(_QWORD *)&wrapperArray[38]._1.cctor_finished_or_no_cctor )
		    {
		      if ( !v5->_1.cctor_finished_or_no_cctor )
		      {
		        il2cpp_runtime_class_init_1(v5);
		      ...
		      if ( !v5 )
		        goto LABEL_34;
		      if ( LODWORD(v5->_0.namespaze) > 0x712 )
		      {
		        v5 = *(struct ILFixDynamicMethodWrapper_2__Class **)&v5[38]._1.cctor_finished_or_no_cctor;
		        if ( v5 )
		          return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_730((ILFixDynamicMethodWrapper_2 *)v5, this, other, 0LL);
		LABEL_34:
		        sub_1800D8250(v5, wrapperArray);
		      }
		LABEL_35:
		      sub_1800D2AA0(v5, wrapperArray, method);
		    }
		  }
		  wrapperArray = TypeInfo::UnityEngine::Object;
		  mesh = this->mesh;
		  v9 = other->mesh;
		  ...
		  if ( v9 != 0LL || mesh != 0LL )
		  {
		    if ( v9 )
		    {
		      ...
		      else
		      {
		        ...
		        v10 = v9->fields._.m_CachedPtr == 0LL;
		      }
		    }
		    else
		    {
		      ...
		      if ( !mesh )
		        goto LABEL_34;
		      v10 = mesh->fields._.m_CachedPtr == 0LL;
		    }
		    if ( !v10 )
		      return 0;
		  }
		  return this->passIndex == other->passIndex && this->ccdKeyword == other->ccdKeyword;
		}
