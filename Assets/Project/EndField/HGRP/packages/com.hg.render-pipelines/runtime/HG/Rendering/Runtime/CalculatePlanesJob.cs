...
{
	[BurstCompile]
	public struct CalculatePlanesJob : IJob // TypeDefIndex: 37755
	{
		// Fields
		public int numTilesX; // 0x00
		public int numTilesY; // 0x04
		[ReadOnly]
		public NativeArray<float3> tileVertices; // 0x08
		[WriteOnly]
		public NativeArray<float4> xPlanes; // 0x18
		[WriteOnly]
		public NativeArray<float4> yPlanes; // 0x28
	
		// Methods
		public void Execute() {} // 0x0000000189CF8A48-0x0000000189CF8C4C
		// Void Execute()
		void HG::Rendering::Runtime::CalculatePlanesJob::Execute(CalculatePlanesJob *this, MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1830, 0LL) )
		  {
		    ...
		    IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_738(Patch, this, 0LL);
		  }
		  else
		  {
		    ...
		    if ( numTilesX >= 0 )
		    {
		      ...
		      do
		      {
		        ...
		        v35 = v12;
		        v36 = v13;
		        v14 = sub_182FAD1A0(v41, &v35, &v33, v3);
		        v15 = *(_QWORD *)v14;
		        LODWORD(v14) = *(_DWORD *)(v14 + 8);
		        v37 = v15;
		        v38 = v14;
		        v16 = sub_1834C8E00(v42, &v37);
		        ++v9;
		        v8 += 12;
		        v39 = *(_QWORD *)v16;
		        *(_QWORD *)&v43 = v39;
		    ...
		    if ( numTilesY >= 0 )
		    {
		      ...
		      do
		      {
		        ...
		        v37 = v25;
		        v38 = v26;
		        v27 = sub_182FAD1A0(v42, &v37, &v39, v3);
		        v28 = *(_QWORD *)v27;
		        LODWORD(v27) = *(_DWORD *)(v27 + 8);
		        v35 = v28;
		        v36 = v27;
		        v29 = sub_1834C8E00(v41, &v35);
		        v20 += v23;
		        v33 = *(_QWORD *)v29;
		        *(_QWORD *)&v43 = v33;
