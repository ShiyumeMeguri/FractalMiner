...
{
	internal class SphericalHarmonicMath // TypeDefIndex: 37896
	{
		// Fields
		private const float c0 = 0.2820948f; // Metadata: 0x023031AC
		private const float c1 = 0.325735f; // Metadata: 0x023031B0
		private const float c2 = 0.27313712f; // Metadata: 0x023031B4
		private const float c3 = 0.07884789f; // Metadata: 0x023031B8
		private const float c4 = 0.13656856f; // Metadata: 0x023031BC
		private static float[] invNormConsts; // 0x00
		private const float k0 = 0.2820948f; // Metadata: 0x023031C0
		private const float k1 = 0.48860252f; // Metadata: 0x023031C4
		private const float k2 = 1.0925485f; // Metadata: 0x023031C8
		private const float k3 = 0.31539157f; // Metadata: 0x023031CC
		private const float k4 = 0.54627424f; // Metadata: 0x023031D0
		private static float[] ks; // 0x08
	
		// Constructors
		public SphericalHarmonicMath() {} // 0x00000001841E1670-0x00000001841E1680
		...
		static SphericalHarmonicMath() {} // 0x0000000189B55D70-0x0000000189B55E14
		// SphericalHarmonicMath()
		void HG::Rendering::Runtime::SphericalHarmonicMath::cctor(MethodInfo *method)
		{
		  Array *v1; // rbx
		  HGRuntimeGrassQuery_Node *static_fields; // r8
		  ...
		  v1 = (Array *)il2cpp_array_new_specific_1(TypeInfo::System::Single, 9LL);
		  System::Runtime::CompilerServices::RuntimeHelpers::InitializeArray(
		    v1,
		    52223DF70CAE5FB4D8E32CC70C600028219173A50489583229A30B6116C157F5_Field,
		    0LL);
		  static_fields = (HGRuntimeGrassQuery_Node *)TypeInfo::HG::Rendering::Runtime::SphericalHarmonicMath->static_fields;
		  static_fields->klass = (HGRuntimeGrassQuery_Node__Class *)v1;
		  sub_18002D1B0(
		    (HGRuntimeGrassQuery_Node *)TypeInfo::HG::Rendering::Runtime::SphericalHarmonicMath->static_fields,
		    v3,
		    static_fields,
		    v4,
		    v9);
		  v5 = (Array *)il2cpp_array_new_specific_1(TypeInfo::System::Single, 9LL);
		  System::Runtime::CompilerServices::RuntimeHelpers::InitializeArray(
		    v5,
		    F8C60E2B2E22E95739FC16901877B439F3B19FEBCB5C54AF2F97C798D4008E48_Field,
		    0LL);
		  v6 = (HGRuntimeGrassQuery_Node *)TypeInfo::HG::Rendering::Runtime::SphericalHarmonicMath->static_fields;
		  v6->monitor = (MonitorData *)v5;
		  sub_18002D1B0(
		    (HGRuntimeGrassQuery_Node *)&TypeInfo::HG::Rendering::Runtime::SphericalHarmonicMath->static_fields->ks,
		    v6,
		    v7,
		    v8,
		    v10);
		...
		// Methods
		public static SphericalHarmonicsL2 Convolve(SphericalHarmonicsL2 sh, ZonalHarmonicsL2 zh) => default; // 0x0000000189B5510C-0x0000000189B55324
		        ...
		        MethodInfo *method)
		{
		  ...
		  __int128 v28; // xmm0
		  __int128 v29; // xmm1
		  SphericalHarmonicsL2 *v30; // rax
		  __int128 v31; // xmm1
		  __int128 v32; // xmm0
		  __int128 v33; // xmm1
		  __int128 v34; // xmm0
		  SphericalHarmonicsL2 v36; // [rsp+30h] [rbp-128h] BYREF
		  SphericalHarmonicsL2 v37; // [rsp+A0h] [rbp-B8h] BYREF
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(2243, 0LL) )
		  {
		    ...
		    if ( Patch )
		    {
		      shb8 = sh->shb8;
		      v25 = *(_OWORD *)&sh->shr4;
		      *(_OWORD *)&v36.shr0 = *(_OWORD *)&sh->shr0;
		      v26 = *(_OWORD *)&sh->shr8;
		      v36.shb8 = shb8;
		      *(_OWORD *)&v36.shr4 = v25;
		      v27 = *(_OWORD *)&sh->shg3;
		      ...
		      *(_OWORD *)&v36.shb2 = v29;
		      v30 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_902(&v37, Patch, &v36, (ZonalHarmonicsL2)coeffs, 0LL);
		      v31 = *(_OWORD *)&v30->shr4;
		      *(_OWORD *)&v5->shr0 = *(_OWORD *)&v30->shr0;
		      v32 = *(_OWORD *)&v30->shr8;
		      *(_OWORD *)&v5->shr4 = v31;
		      v33 = *(_OWORD *)&v30->shg3;
		      *(_OWORD *)&v5->shr8 = v32;
		...
		LABEL_13:
		  ...
		  do
		  {
		    if ( (unsigned int)v10 >= coeffs->max_length.size )
		      sub_1800D2AB0(v8, Patch);
		    v12 = v9;
		    v13 = sub_1803386C0(v8, Patch) * coeffs->vector[v10];
		    if ( v9 <= v10 )
		    {
		      do
		      {
		        ...
		        for ( i = 0; i < 3; ++i )
		        {
		          Item = UnityEngine::Rendering::SphericalHarmonicsL2::get_Item(sh, i, v14, 0LL);
		          UnityEngine::Rendering::SphericalHarmonicsL2::set_Item(sh, i, v14, Item * v13, 0LL);
		        }
		        ++v12;
		      }
		      while ( v12 <= v10 );
		...
		public static SphericalHarmonicsL2 UndoCosineRescaling(SphericalHarmonicsL2 sh) => default; // 0x0000000189B55BB0-0x0000000189B55D70
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(2244, 0LL) )
		  {
		    ...
		    if ( !Patch )
		LABEL_11:
		      sub_1800D8260(static_fields, Patch);
		    v17 = *(_OWORD *)&sh->shr0;
		    v18 = *(_OWORD *)&sh->shr4;
		    v29.shb8 = sh->shb8;
		    *(_OWORD *)&v29.shr0 = v17;
		    ...
		    *(_OWORD *)&v29.shb2 = v22;
		    v23 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_903(&v30, Patch, &v29, 0LL);
		    v24 = *(_OWORD *)&v23->shr4;
		  ...
		  else
		  {
		    for ( i = 0; i < 3; ++i )
		    {
		      for ( j = 0; j < 9; ++j )
		      {
		        ...
		        sub_1800036A0(TypeInfo::HG::Rendering::Runtime::SphericalHarmonicMath);
		        ...
		        if ( (unsigned int)j >= Patch->fields.methodId )
		          sub_1800D2AB0(static_fields, Patch);
		...
		public static SphericalHarmonicsL2 PremultiplyCoefficients(SphericalHarmonicsL2 sh) => default; // 0x0000000189B55864-0x0000000189B55A24
		...
		public static SphericalHarmonicsL2 RescaleCoefficients(SphericalHarmonicsL2 sh, float scalar) => default; // 0x0000000189B55A24-0x0000000189B55BB0
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(2246, 0LL) )
		  {
		    ...
		    *(_OWORD *)&v30.shb2 = v23;
		    v24 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_904(&v31, Patch, &v30, scalar, 0LL);
		    v25 = *(_OWORD *)&v24->shr4;
		...
		public static void PackCoefficients(Vector4[] packedCoeffs, [IsReadOnly] in SphericalHarmonicsL2 sh) {} // 0x0000000189B55324-0x0000000189B55864
		...
		LABEL_9:
		      sub_1800D8260(v6, v5);
		    IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_905(Patch, (Object *)packedCoeffs, sh, 0LL);
		  }
		  else
		  {
		    v8 = 0;
		    do
		    {
		      ...
		      *(_OWORD *)&v97.shb2 = v41;
		      ...
		      v43 = sub_180002100(packedCoeffs, v8++);
		      *(_DWORD *)v43 = v17;
		      *(_DWORD *)(v43 + 4) = v24;
		      *(_DWORD *)(v43 + 8) = v31;
		      *(float *)(v43 + 12) = v42;
		    ...
		    do
		    {
		      ...
		      *(_OWORD *)&v97.shb2 = v71;
		      ...
		      v73 = sub_180002100(packedCoeffs, v44);
		      ++v7;
		      ++v44;
		      *(_DWORD *)v73 = v53;
		      *(float *)(v73 + 8) = v67 * 3.0;
		    ...
		    *(_OWORD *)&v97.shb2 = v93;
		    ...
		    v95 = (float *)sub_180002100(packedCoeffs, 6LL);
		    *(_DWORD *)v95 = v83;
		    *((_DWORD *)v95 + 1) = v90;
		    v95[2] = v94;
		    v95[3] = 1.0;
