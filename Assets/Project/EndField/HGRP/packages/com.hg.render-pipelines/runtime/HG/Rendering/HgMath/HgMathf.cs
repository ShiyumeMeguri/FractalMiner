...
{
	public static class HgMathf // TypeDefIndex: 37474
	{
		// Methods
		internal static float TriangleSign2D(Vector2 p1, Vector2 p2, Vector2 p3) => default; // 0x0000000189B3E6C8-0x0000000189B3E79C
		...
		float HG::Rendering::HgMath::HgMathf::TriangleSign2D(Vector2 p1, Vector2 p2, Vector2 p3, MethodInfo *method)
		{
		  ...
		  return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_156(Patch, p1, p2, p3, 0LL);
		}
		
		public static bool PointTriangleContainTest2D(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 point) => default; // 0x0000000189B3D928-0x0000000189B3DA48
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(343, 0LL) )
		  {
		    ...
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_157(Patch, p0, p1, p2, point, 0LL);
		  }
		  else
		  {
		...
		public static Vector2 LineLineIntersectPoint2D(Vector2 l00, Vector2 l01, Vector2 l10, Vector2 l11) => default; // 0x0000000189B3C4F4-0x0000000189B3C648
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(344, 0LL) )
		  {
		    ...
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_158(Patch, l00, l01, l10, l11, 0LL);
		  }
		  else
		  {
		...
		public static bool LineLineIntersect2D(Vector2 l00, Vector2 l01, Vector2 l10, Vector2 l11) => default; // 0x0000000189B3C404-0x0000000189B3C4F4
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(345, 0LL) )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(345, 0LL);
		    if ( !Patch )
		      sub_1800D8260(v12, v11);
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_157(Patch, l00, l01, l10, l11, 0LL);
		  }
		  else
		  {
		...
		public static bool LineSegmentTriangleIntersect2D(Vector2 lp0, Vector2 lp1, Vector2 tp0, Vector2 tp1, Vector2 tp2) => default; // 0x0000000189B3CD90-0x0000000189B3CEBC
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( !IFix::WrappersManagerImpl::IsPatched(346, 0LL) )
		  ...
		  Patch = IFix::WrappersManagerImpl::GetPatch(346, 0LL);
		  if ( !Patch )
		    sub_1800D8260(v13, v12);
		  return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_159(Patch, lp0, lp1, tp0, tp1, tp2, 0LL);
		}
		
		public static bool LineSegmentAABBIntersect(Vector3 lp0, Vector3 lp1, Vector3 center, float halfSize) => default; // 0x0000000189B3C648-0x0000000189B3CD90
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(347, 0LL) )
		  {
		    ...
		    *(_QWORD *)&v110.x = v106;
		    v110.z = v107;
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_161(Patch, &v110, &v108, &v109, halfSize, 0LL);
		  }
		  else
		  {
		...
		public static bool TriangleAABBIntersect(Vector3 tp0, Vector3 tp1, Vector3 tp2, Vector3 center, Vector3 extent) => default; // 0x0000000189B3DA48-0x0000000189B3E6C8
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(349, 0LL) )
		  {
		    ...
		    *(_QWORD *)&v207.x = *(_QWORD *)&tp0->x;
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_162(Patch, &v207, &v209, &v210, &v208, &v206, 0LL);
		  }
		  else
		  {
		    v11 = center->z;
		...
		internal static bool CanAxisSeparateProjection(Vector3 axis, Vector3 v0, Vector3 v1, Vector3 v2, Vector3 aabbExtent) => default; // 0x0000000189B3C100-0x0000000189B3C380
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(350, 0LL) )
		  {
		    ...
		    *(_QWORD *)&v48.x = *(_QWORD *)&axis->x;
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_162(Patch, &v48, &v49, &v50, &v51, &v52, 0LL);
		  }
		  else
		  {
		    v11 = axis->z;
		...
		public static bool InRange(float val, float min, float max) => default; // 0x0000000189B3C380-0x0000000189B3C404
		...
		bool HG::Rendering::HgMath::HgMathf::InRange(float val, float min, float max, MethodInfo *method)
		{
		  ...
		  result = IFix::WrappersManagerImpl::IsPatched(348, 0LL);
		  if ( result )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(348, 0LL);
		    if ( !Patch )
		      sub_1800D8260(v7, v6);
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_160(Patch, val, min, max, 0LL);
		  }
		  else if ( val >= min )
		  {
		    return max >= val;
		...
		public static bool MeshConvexTest(Mesh.MeshData meshData, float sizeTolerance = 0f /* Metadata: 0x02302D9B */, float planeTolerance = 0.1f /* Metadata: 0x02302D9F */) => default; // 0x0000000189B3CEBC-0x0000000189B3D928
		        ...
		        MethodInfo *method)
		{
		  ...
		  __int64 v70; // rdx
		  __int64 v71; // rcx
		  __int64 v72; // [rsp+0h] [rbp-2D8h] BYREF
		  float v73; // [rsp+30h] [rbp-2A8h]
		  float v74; // [rsp+34h] [rbp-2A4h]
		  Vector3 v75; // [rsp+38h] [rbp-2A0h]
		  unsigned __int64 v76; // [rsp+48h] [rbp-290h] BYREF
		  float v77; // [rsp+50h] [rbp-288h]
		  __int64 v78; // [rsp+58h] [rbp-280h]
		  __int64 v79; // [rsp+60h] [rbp-278h]
		  __int64 v80; // [rsp+68h] [rbp-270h]
		  NativeArray_1_UnityEngine_Vector3_ v81; // [rsp+70h] [rbp-268h] BYREF
		  __int64 v82; // [rsp+80h] [rbp-258h]
		  float v83; // [rsp+88h] [rbp-250h]
		  List_1_System_Int32_ *v84; // [rsp+90h] [rbp-248h]
		  NativeArray_1_T_ReadOnly_T_Enumerator_BeyondDynamicBone_StepReductionBase_JoinEdge_ v85; // [rsp+A0h] [rbp-238h] BYREF
		  NativeArray_1_T_ReadOnly_T_Enumerator_BeyondDynamicBone_StepReductionBase_JoinEdge_ v86; // [rsp+D0h] [rbp-208h] BYREF
		  float v87[4]; // [rsp+F0h] [rbp-1E8h]
		  NativeArray_1_System_Int32_ v88; // [rsp+100h] [rbp-1D8h] BYREF
		  Vector3 v89; // [rsp+110h] [rbp-1C8h] BYREF
		  float v90[4]; // [rsp+120h] [rbp-1B8h]
		  float v91[4]; // [rsp+130h] [rbp-1A8h]
		  float v92[4]; // [rsp+140h] [rbp-198h]
		  float v93[4]; // [rsp+150h] [rbp-188h]
		  float v94[4]; // [rsp+160h] [rbp-178h]
		  float v95[4]; // [rsp+170h] [rbp-168h]
		  float v96[4]; // [rsp+180h] [rbp-158h]
		  float v97[4]; // [rsp+190h] [rbp-148h]
		  float v98[4]; // [rsp+1A0h] [rbp-138h]
		  unsigned __int64 v99; // [rsp+1B0h] [rbp-128h] BYREF
		  float v100; // [rsp+1B8h] [rbp-120h]
		  Il2CppExceptionWrapper *v101; // [rsp+1C0h] [rbp-118h] BYREF
		  Il2CppExceptionWrapper *v102; // [rsp+1C8h] [rbp-110h] BYREF
		  _BYTE v103[16]; // [rsp+1D0h] [rbp-108h] BYREF
		  _BYTE v104[16]; // [rsp+1E0h] [rbp-F8h] BYREF
		  SubMeshDescriptor v105[3]; // [rsp+1F0h] [rbp-E8h] BYREF
		  Mesh_MeshData v106; // [rsp+2E0h] [rbp+8h] BYREF
		  float v107; // [rsp+2E8h] [rbp+10h]
		  float v108; // [rsp+2F0h] [rbp+18h]
		
		  v108 = planeTolerance;
		  v107 = sizeTolerance;
		  v106.m_Ptr = meshData.m_Ptr;
		  v4 = planeTolerance;
		  v5 = sizeTolerance;
		  v81 = 0LL;
		  v88 = 0LL;
		  if ( IFix::WrappersManagerImpl::IsPatched(351, 0LL) )
		  {
		    ...
		    return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_163(Patch, meshData, sizeTolerance, planeTolerance, 0LL);
		  }
		  *(float *)&v7 = COERCE_FLOAT(UnityEngine::Mesh::MeshData::get_vertexCount(&v106, 0LL));
		  v73 = *(float *)&v7;
		  if ( v7 <= 3 )
		    return 0;
		  *(float *)&v8 = COERCE_FLOAT(UnityEngine::Mesh::MeshData::get_subMeshCount(&v106, 0LL));
		  v74 = *(float *)&v8;
		  v9 = 2;
		  ...
		  v85.m_Array = (NativeArray_1_T_ReadOnly_BeyondDynamicBone_StepReductionBase_JoinEdge_)v81;
		  UnityEngine::Mesh::MeshData::GetVertices(&v106, (NativeArray_1_UnityEngine_Vector3_ *)&v85, 0LL);
		  ...
		  v84 = v13;
		  v75 = *UnityEngine::Animator::GetVector(&v89, v14, v15, v16);
		  Unity::Collections::NativeArray_1_T_::ReadOnly<BeyondDynamicBone::StepReductionBase::JoinEdge>::GetEnumerator(
		    &v85,
		    (NativeArray_1_T_ReadOnly_BeyondDynamicBone_StepReductionBase_JoinEdge_ *)&v81,
		    MethodInfo::Unity::Collections::NativeArray<UnityEngine::Vector3>::GetEnumerator);
		  v86 = v85;
		  v85.m_Array.m_Buffer = 0LL;
		  *(_QWORD *)&v85.m_Array.m_Length = &v86;
		  try
		  {
		    ...
		    {
		      x = (__m128)(unsigned int)v86.value.vertexPair.x;
		      x.m128_f32[0] = *(float *)&v86.value.vertexPair.x + v75.x;
		      y = (__m128)(unsigned int)v86.value.vertexPair.y;
		      y.m128_f32[0] = *(float *)&v86.value.vertexPair.y + v75.y;
		      *(_QWORD *)&v75.x = _mm_unpacklo_ps(x, y).m128_u64[0];
		      v75.z = v86.value.cost + v75.z;
		    }
		  }
		  catch ( Il2CppExceptionWrapper *v101 )
		  {
		    v85.m_Array.m_Buffer = (Void *)v101->ex;
		    if ( v85.m_Array.m_Buffer )
		      sub_18007E1E0(v85.m_Array.m_Buffer);
		    v9 = 2;
		    v4 = v108;
		    v5 = v107;
		    *(float *)&v7 = v73;
		  ...
		  y_low = (__m128)LODWORD(v75.y);
		  y_low.m128_f32[0] = v75.y / (float)v7;
		  x_low = (__m128)LODWORD(v75.x);
		  x_low.m128_f32[0] = v75.x / (float)v7;
		  *(_QWORD *)&v75.x = _mm_unpacklo_ps(x_low, y_low).m128_u64[0];
		  v75.z = v75.z / (float)v7;
		  v21 = 0.0;
		  v73 = 0.0;
		  Unity::Collections::NativeArray_1_T_::ReadOnly<BeyondDynamicBone::StepReductionBase::JoinEdge>::GetEnumerator(
		    &v85,
		  ...
		  *(_QWORD *)&v85.m_Array.m_Length = &v86;
		  try
		  {
		    while ( Unity::Collections::NativeArray_1_T__ReadOnly_T_::Enumerator<BeyondDynamicBone::StepReductionBase::JoinEdge>::MoveNext(
		              ...
		              MethodInfo::Unity::Collections::NativeArray_1_T_::Enumerator<UnityEngine::Vector3>::MoveNext) )
		    {
		      v24 = (__m128)(unsigned int)v86.value.vertexPair.y;
		      v24.m128_f32[0] = *(float *)&v86.value.vertexPair.y - v75.y;
		      v25 = (__m128)(unsigned int)v86.value.vertexPair.x;
		      v25.m128_f32[0] = *(float *)&v86.value.vertexPair.x - v75.x;
		      v76 = _mm_unpacklo_ps(v25, v24).m128_u64[0];
		      v77 = v86.value.cost - v75.z;
		      v26 = sub_182F9FF00(&v76);
		      if ( v26 > v21 )
		      {
		        v21 = v26;
		        v73 = v26;
		  ...
		  {
		    v22 = &v72;
		    v85.m_Array.m_Buffer = (Void *)v102->ex;
		    m_Buffer = v85.m_Array.m_Buffer;
		    if ( v85.m_Array.m_Buffer )
		      sub_18007E1E0(v85.m_Array.m_Buffer);
		    v9 = 2;
		    v4 = v108;
		  ...
		  if ( v8 > 0 )
		  {
		    while ( 1 )
		    {
		      SubMesh = UnityEngine::Mesh::MeshData::GetSubMesh(v105, &v106, v27, 0LL);
		      v85.m_Array = *(NativeArray_1_T_ReadOnly_BeyondDynamicBone_StepReductionBase_JoinEdge_ *)&SubMesh->_bounds_k__BackingField.m_Center.x;
		      *(_OWORD *)&v85.m_Index = *(_OWORD *)&SubMesh->_bounds_k__BackingField.m_Extents.y;
		      ...
		      v85.m_Array = (NativeArray_1_T_ReadOnly_BeyondDynamicBone_StepReductionBase_JoinEdge_)v88;
		      UnityEngine::Mesh::MeshData::GetIndices(&v106, (NativeArray_1_System_Int32_ *)&v85, v27, 1, 0LL);
		      v29 = (IEnumerable_1_System_Int32_ *)Unity::Collections::NativeArray<MagicaCloth::TwistConstraint::TwistData>::ToArray(
		                                             (NativeArray_1_MagicaCloth_TwistConstraint_TwistData_ *)&v88,
		      ...
		      Unity::Collections::NativeArray<UnityEngine::Vector4>::Dispose(
		        (NativeArray_1_UnityEngine_Vector4_ *)&v88,
		        MethodInfo::Unity::Collections::NativeArray<int>::Dispose);
		      if ( ++v27 >= v8 )
		        goto LABEL_20;
		    }
		LABEL_44:
		    sub_1800D8250(m_Buffer, v22);
		  }
		  if ( !v13 )
		    goto LABEL_44;
		LABEL_20:
		...
		LABEL_38:
		    Unity::Collections::NativeArray<BeyondDynamicBone::TeamManager::TeamData>::Dispose(
		      (NativeArray_1_BeyondDynamicBone_TeamManager_TeamData_ *)&v81,
		  ...
		  while ( 1 )
		  {
		    ...
		    v33 = Item;
		    LODWORD(v78) = Item;
		    v34 = System::Collections::Generic::List<int>::get_Item(
		            v13,
		            v9 - 1,
		            MethodInfo::System::Collections::Generic::List<int>::get_Item);
		    v35 = v34;
		    LODWORD(v79) = v34;
		    LODWORD(v80) = System::Collections::Generic::List<int>::get_Item(
		                     v13,
		                     v9,
		                     MethodInfo::System::Collections::Generic::List<int>::get_Item);
		    *(_QWORD *)v95 = *(_QWORD *)&v81.m_Buffer[12 * v33];
		    v36 = *(float *)&v81.m_Buffer[12 * v33 + 8];
		    v37 = 3 * v35;
		    *(_QWORD *)v96 = *(_QWORD *)&v81.m_Buffer[12 * (int)v80];
		    LODWORD(v35) = *(_DWORD *)&v81.m_Buffer[12 * (int)v80 + 8];
		    *(_QWORD *)v90 = *(_QWORD *)&v81.m_Buffer[4 * v37];
		    *(_QWORD *)v91 = *(_QWORD *)&v81.m_Buffer[12 * v33];
		    v38 = *(float *)&v81.m_Buffer[4 * v37 + 8] + *(float *)&v81.m_Buffer[12 * v33 + 8];
		    *(_QWORD *)v92 = *(_QWORD *)&v81.m_Buffer[12 * (int)v80];
		    v39 = *(float *)&v81.m_Buffer[12 * (int)v80 + 8] + v38;
		    v40 = (float)(v92[0] + (float)(v90[0] + v91[0])) / 3.0;
		    v74 = v40;
		    v41 = (float)(v92[1] + (float)(v90[1] + v91[1])) / 3.0;
		    v73 = v41;
		    *(float *)&v84 = v39 / 3.0;
		    *(_QWORD *)v94 = *(_QWORD *)&v81.m_Buffer[4 * v37];
		    *(_QWORD *)v93 = *(_QWORD *)&v81.m_Buffer[12 * v33];
		    v42 = (__m128)LODWORD(v93[0]);
		    v42.m128_f32[0] = v93[0] - v94[0];
		    v43 = (__m128)LODWORD(v93[1]);
		    v43.m128_f32[0] = v93[1] - v94[1];
		    v44 = *(float *)&v81.m_Buffer[12 * v33 + 8] - *(float *)&v81.m_Buffer[4 * v37 + 8];
		    v76 = _mm_unpacklo_ps(v42, v43).m128_u64[0];
		    v77 = v44;
		    v45 = sub_182FAE2B0(v103, &v76);
		    *(_QWORD *)v87 = *(_QWORD *)v45;
		    LODWORD(v33) = *(_DWORD *)(v45 + 8);
		    v46 = (__m128)LODWORD(v95[0]);
		    v46.m128_f32[0] = v95[0] - v96[0];
		    v47 = (__m128)LODWORD(v95[1]);
		    v47.m128_f32[0] = v95[1] - v96[1];
		    v76 = _mm_unpacklo_ps(v46, v47).m128_u64[0];
		    v77 = v36 - *(float *)&v35;
		    v48 = sub_182FAE2B0(v104, &v76);
		    *(_QWORD *)v97 = *(_QWORD *)v48;
		    v49 = (__m128)*(unsigned int *)(v48 + 8);
		    v49.m128_f32[0] = (float)(v49.m128_f32[0] * v87[1]) - (float)(v97[1] * *(float *)&v33);
		    v50 = (__m128)LODWORD(v97[0]);
		    v50.m128_f32[0] = (float)(v97[0] * *(float *)&v33) - (float)(*(float *)(v48 + 8) * v87[0]);
		    v76 = _mm_unpacklo_ps(v49, v50).m128_u64[0];
		    v77 = (float)(v97[1] * v87[0]) - (float)(v97[0] * v87[1]);
		    v51 = sub_182FAE2B0(&v85, &v76);
		    v82 = *(_QWORD *)v51;
		    v83 = *(float *)(v51 + 8);
		    v52 = (LowLevelList_1_System_Object_ *)sub_18002C620(TypeInfo::System::Collections::Generic::List<float>);
		    *(_QWORD *)&v75.x = v52;
		    if ( !v52 )
		      goto LABEL_44;
		...
		LABEL_37:
		  ...
		  while ( 1 )
		  {
		    if ( v54 == v55 || v54 == v56 || v54 == v57 )
		      goto LABEL_36;
		    *(_QWORD *)v98 = *(_QWORD *)v58;
		    v59 = (__m128)LODWORD(v98[0]);
		    v59.m128_f32[0] = v98[0] - v40;
		    v60 = (__m128)LODWORD(v98[1]);
		    v60.m128_f32[0] = v98[1] - v41;
		    v61 = *(float *)&v58[8] - *(float *)&v84;
		    v99 = _mm_unpacklo_ps(v59, v60).m128_u64[0];
		    v100 = v61;
		    v62 = sub_182FAE2B0(&v88, &v99);
		    *(_QWORD *)&v89.x = *(_QWORD *)v62;
		    v64 = (float)((float)(v89.y * *((float *)&v82 + 1)) + (float)(v89.x * *(float *)&v82))
		        + (float)(*(float *)(v62 + 8) * v83);
		    if ( v4 < fabs(v64) )
		      break;
		LABEL_35:
		    v57 = v80;
		...
		LABEL_36:
		  ...
		  v66 = UnityEngine::Mathf::Sign(v64, v63);
		  if ( !*(_DWORD *)(*(_QWORD *)&v75.x + 24LL) )
		  {
		    sub_1830BADF0(*(_QWORD *)&v75.x, v65, MethodInfo::System::Collections::Generic::List<float>::Add);
		LABEL_34:
		    v40 = v74;
		    goto LABEL_35;
		  }
		  v67 = System::Collections::Generic::List<float>::get_Item(
		          *(List_1_System_Single_ **)&v75.x,
		          0,
		          MethodInfo::System::Collections::Generic::List<float>::get_Item);
		  sub_1800036A0(TypeInfo::System::Math);
		  if ( fabs(v66 - v67) <= 0.0099999998
		    || (float)(fabs(
		                 (float)((float)(v59.m128_f32[0] * *(float *)&v82) + (float)(v60.m128_f32[0] * *((float *)&v82 + 1)))
		               + (float)(v61 * v83))
		             / v21) <= v5 )
		  {
		    goto LABEL_34;
