...
namespace HG.Rendering.Runtime
{
	internal static class VisibleLightExtensionMethods
	{
		public static Vector3 GetPosition(this VisibleLight value)
		{
			...
			// 
			//   if ( IFix::WrappersManagerImpl::IsPatched(1610, 0LL) )
			//   {
			...
			//     v9 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_615(&v24, Patch, &v26, 0LL);
			//   }
			//   else
			//   {
		...
		public static Vector4 GetHomogeneousPosition(this VisibleLight value)
		{
			...
			//     Column = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_641(&v21, Patch, &v23, 0LL);
			//   }
			//   else
			//   {
			//     v5 = *(_OWORD *)&value.m_LocalToWorldMatrix.m01;
		...
		public static VisibleLightExtensionMethods.VisibleLightAxisAndPosition GetAxisAndPosition(this VisibleLight value)
		{
			...
			//   if ( IFix::WrappersManagerImpl::IsPatched(1665, 0LL) )
			//   {
			//     Patch = IFix::WrappersManagerImpl::GetPatch(1665, 0LL);
			//     if ( !Patch )
			...
			//     v32 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_642(&v36, Patch, &v38, 0LL);
			...
			// }
			// 
			return default(VisibleLightExtensionMethods.VisibleLightAxisAndPosition);
		}
