...
namespace HG.Rendering.HgMath
{
	...
	{
		// (get) Token: 0x06000341 RID: 833 RVA: 0x000025D8 File Offset: 0x000007D8
		public bool IsInside
		{
			get
			{
				...
				//   if ( !byte_18D9193C3 )
				//   {
				//     sub_18003C530(&TypeInfo::HG::Rendering::HgMath::Barycentric);
				//     byte_18D9193C3 = 1;
				//   }
				...
				//     return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_160(Patch, this, 0LL);
				//   }
				//   else
				//   {
				//     u = this.u;
				//     sub_180002C70(TypeInfo::HG::Rendering::HgMath::Barycentric);
		...
		public Barycentric(Vector2 aV1, Vector2 aV2, Vector2 aV3, Vector2 aP)
		{
			...
			// 
			//   v17 = ((__int64 (__fastcall *)(_QWORD, _QWORD))sub_18473B264)(aV2, aV3);
			//   v16 = ((__int64 (__fastcall *)(_QWORD, _QWORD))sub_18473B264)(aV1, v7);
			//   aPa = (Vector2)((__int64 (__fastcall *)(_QWORD, _QWORD))sub_18473B264)(aP, v8);
		...
		public static bool IsInTriangle(Vector3 T, Vector3 A, Vector3 B, Vector3 C)
		{
			...
			//     v46.z = v41;
			//     *(_QWORD *)&v46.x = v42;
			//     return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_159(Patch, &v46, &v45, &v43, &v44, 0LL);
			//   }
			//   else
			//   {
			//     v10 = C.z;
