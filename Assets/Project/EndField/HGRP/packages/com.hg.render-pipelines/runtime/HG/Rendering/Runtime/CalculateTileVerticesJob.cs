...
{
	[BurstCompile]
	public struct CalculateTileVerticesJob : IJobParallelFor // TypeDefIndex: 37756
	{
		// Fields
		public int tileSize; // 0x00
		public int numVerticesX; // 0x04
		public int actualWidth; // 0x08
		public int actualHeight; // 0x0C
		[ReadOnly]
		public NativeArray<float3> frustumCorners; // 0x10
		[NativeDisableParallelForRestriction]
		public NativeArray<float3> tileVertices; // 0x20
	
		// Methods
		public void Execute(int y) {} // 0x0000000189CF8C4C-0x0000000189CF8EC0
		// Void Execute(Int32)
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1831, 0LL) )
		  {
		    ...
		    IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_739(Patch, this, y, 0LL);
		  }
		  else
		  {
