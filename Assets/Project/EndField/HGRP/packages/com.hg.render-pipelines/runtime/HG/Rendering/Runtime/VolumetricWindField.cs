...
{
	[ExecuteInEditMode]
	public class VolumetricWindField : MonoBehaviour, IVolumetricWindField
	{
		// (get) Token: 0x06001BA5 RID: 7077 RVA: 0x000025D8 File Offset: 0x000007D8
		private bool directionalWind
		{
			get
			{
				// // Boolean IsAssetInput()
				// bool HoudiniEngineUnity::HEU_InputNode::IsAssetInput(HEU_InputNode *this, MethodInfo *method)
				// {
				//   return this.fields._inputNodeType == 0;
				// }
				// 
				return default(bool);
			}
		...
		// (get) Token: 0x06001BA6 RID: 7078 RVA: 0x000025D8 File Offset: 0x000007D8
		private bool circularWind
		{
			get
			{
				// // Boolean IsIntermediate()
				// bool HoudiniEngineUnity::HEU_GeoNode::IsIntermediate(HEU_GeoNode *this, MethodInfo *method)
				// {
				//   return this.fields._geoInfo.type == 1;
				// }
				// 
				return default(bool);
			}
		...
		// (get) Token: 0x06001BA7 RID: 7079 RVA: 0x000025D8 File Offset: 0x000007D8
		private bool vortexWind
		{
			get
			{
		...
		private void OnEnable()
		{
			...
			//   if ( !byte_18D91982B )
			//   {
			//     sub_18003C530(&MethodInfo::UnityEngine::Component::GetComponentInParent<HG::Rendering::Runtime::VolumetricCloudSDF>);
		...
		private void Update()
		{
			...
			//   ILFixDynamicMethodWrapper_2 *Patch; // rax
			//   Vector3 v33; // [rsp+20h] [rbp-50h] BYREF
			//   Vector3 v34; // [rsp+30h] [rbp-40h] BYREF
			//   Vector3 v35; // [rsp+40h] [rbp-30h] BYREF
			// 
			...
			//     *(_QWORD *)&v33.x = v3;
			//     v33.z = z;
			//     v7 = UnityEngine::Vector3::op_Multiply(&v34, &v33, deltaTime, v6);
			//     v8 = *(_QWORD *)&v7.x;
			//     *(float *)&v7 = v7.z;
			//     *(_QWORD *)&v33.x = v8;
			//     LODWORD(v33.z) = (_DWORD)v7;
			//     v10 = UnityEngine::Vector3::op_Multiply(&v34, &v33, 0.050000001, v9);
			...
			//     *(_QWORD *)&v33.x = v13;
			//     *(_QWORD *)&v34.x = v11;
			//     LODWORD(v34.z) = (_DWORD)v10;
			//     v15 = UnityEngine::Vector3::op_Addition(&v35, &v34, &v33, v14);
			...
			//         v27 = UnityEngine::Time::get_deltaTime(0LL);
			//         if ( !m_VortexRingOffset )
			//           break;
			//         if ( (unsigned int)v24 >= m_VortexRingOffset.max_length.size )
			//           goto LABEL_16;
			//         m_VortexRingOffset.vector[v24] = (float)(v27 * v26) * 0.050000001;
			//         m_VortexRingPhase = this.fields.m_VortexRingPhase;
			//         if ( !m_VortexRingPhase )
			//           break;
			//         v28 = (float *)sub_18003ECE0(m_VortexRingPhase, v24);
			//         v20 = this.fields.m_VortexRingOffset;
			//         if ( !v20 )
			//           break;
			//         if ( (unsigned int)v24 >= v20.max_length.size )
			// LABEL_16:
			//           sub_180070270(m_VortexRingPhase, v20);
			//         *v28 = v20.vector[v24] + *v28;
			//         m_VortexRingPhase = this.fields.m_VortexRingPhase;
			//         if ( !m_VortexRingPhase )
			//           break;
			//         v29 = (int *)sub_18003ECE0(m_VortexRingPhase, v24);
			//         v30 = *v29;
			//         Beyond::JobMathf::Fmod(v31, 1.0, 0.050000001);
			//         ++v24;
			//         *v29 = v30;
			...
			//       }
			// LABEL_18:
			//       sub_180B536AC(m_VortexRingPhase, v20);
			//     }
			//   }
			// }
			// 
		...
		public FWindFieldData GetWindFieldData()
		{
			...
			//     if ( Patch )
			//     {
			//       v52 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_1334(&v59, Patch, (Object *)this, 0LL);
			//       Param1 = v52.Param1;
		...
		public const int MAX_RING_NUM = 4;

		[SerializeField]
		public EWindFieldType Type;
		...
		[SerializeField]
		[Range(1f, 4f)]
		public int vortexRingCount;

		[SerializeField]
		public float[] vortexRingSpeeds;

		[Range(0f, 1f)]
		[SerializeField]
		public float vortexRingBlend;

		[SerializeField]
		[Range(-0.25f, 0.25f)]
		public float vortexRingSkew;

		private Vector3 m_DirectionalWindPhase;

		private Vector3 m_DirectionalWindOffset;

		private float m_CircularWindPhase;

		private float m_CircularWindOffset;

		private float[] m_VortexRingPhase;

		private float[] m_VortexRingOffset;
	}
}
