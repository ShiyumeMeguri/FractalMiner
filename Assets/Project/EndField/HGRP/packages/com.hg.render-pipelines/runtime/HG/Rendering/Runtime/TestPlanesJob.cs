...
{
	[BurstCompile]
	public struct TestPlanesJob : IJobParallelFor // TypeDefIndex: 37794
	{
		// Fields
		public int numTilesX; // 0x00
		public int numTilesY; // 0x04
		public float3 cameraPosition; // 0x08
		[ReadOnly]
		public NativeArray<float4> lightSphereData; // 0x18
		[ReadOnly]
		public NativeArray<float4> xPlanes; // 0x28
		[ReadOnly]
		public NativeArray<float4> yPlanes; // 0x38
		[NativeDisableParallelForRestriction]
		public NativeArray<bool2> xIntersections; // 0x48
		[NativeDisableParallelForRestriction]
		public NativeArray<bool2> yIntersections; // 0x58
		[NativeDisableParallelForRestriction]
		...
		// Methods
		public void Execute(int lightIndex) {} // 0x0000000189D11358-0x0000000189D115C0
		// Void Execute(Int32)
		void HG::Rendering::Runtime::TestPlanesJob::Execute(TestPlanesJob *this, int32_t lightIndex, MethodInfo *method)
		{
		  ...
		  v3 = lightIndex;
		  v5 = 0;
		  if ( IFix::WrappersManagerImpl::IsPatched(1974, 0LL) )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(1974, 0LL);
		    if ( !Patch )
		      sub_1800D8260(v36, v35);
		    IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_793(Patch, this, v3, 0LL);
		  }
		  else
		  {
