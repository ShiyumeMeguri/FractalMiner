...
{
	internal static class HGTextureUtilities
	{
		public static void WriteTextureFileToDisk(Texture target, string filePath)
		{
			...
			//   if ( !byte_18D919769 )
			//   {
			//     sub_18003C530(&TypeInfo::UnityEngine::Rendering::CommandBuffer);
			...
			//   {
			//     v5 = 0LL;
			//     v6 = (RenderTexture *)sub_18003F5A0(target, TypeInfo::UnityEngine::RenderTexture);
			...
			//           v12 = sub_18000F7E0(&MethodInfo::HG::Rendering::Runtime::HGTextureUtilities::WriteTextureFileToDisk);
			...
			//               0LL),
			//             (v17 = (CommandBuffer *)sub_180004920(TypeInfo::UnityEngine::Rendering::CommandBuffer)) == 0LL) )
			//       {
			// LABEL_20:
			//         sub_180B536AC(v8, v7);
			//       }
			...
			//         v20 = sub_18003ED00(5LL);
			//         v21 = sub_18003ED00(7LL);
		...
		public static Texture2D CopyRenderTextureToTexture2D(RenderTexture source)
		{
			...
			//     if ( !Patch )
			//       goto LABEL_17;
			//     return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_352(Patch, (Object *)source, 0LL);
			//   }
			//   else
			//   {
			//     if ( !source )
			...
			//     v7 = sub_18003ED00(9LL);
			//     if ( v7 == 2 )
			//     {
			//       v8 = sub_18003ED00(5LL);
			//       v9 = (Texture2D *)sub_180004920(TypeInfo::UnityEngine::Texture2D);
			//       v10 = v9;
			//       if ( v9 )
			//       {
			...
			//     if ( v7 != 4 )
			//     {
			//       v12 = sub_18000F7E0(&TypeInfo::System::ArgumentException);
			//       v13 = (ArgumentException *)sub_180004920(v12);
			//       v14 = v13;
			//       if ( v13 )
			//       {
			//         System::ArgumentException::ArgumentException(v13, 0LL);
			//         v15 = sub_18000F7E0(&MethodInfo::HG::Rendering::Runtime::HGTextureUtilities::CopyRenderTextureToTexture2D);
			...
			//     v19 = (CommandBuffer *)sub_180004920(TypeInfo::UnityEngine::Rendering::CommandBuffer);
			//     if ( !v19 )
			//       goto LABEL_17;
			...
			//       UnityEngine::Rendering::CommandBuffer::CopyTexture(v19, v36, v20++, 0, 0, 0, v16, v16, &v35, 0, 0, v2, 0, 0LL);
			//       v2 += v16;
			//     }
			//     while ( v20 < 6 );
			//     sub_180002C70(TypeInfo::UnityEngine::Graphics);
			//     UnityEngine::Graphics::ExecuteCommandBuffer(v19, 0LL);
			//     v28 = (Texture2D *)sub_180004920(TypeInfo::UnityEngine::Texture2D);
			//     v29 = v28;
			//     if ( !v28 )
			// LABEL_17:
			//       sub_180B536AC(v5, v4);
