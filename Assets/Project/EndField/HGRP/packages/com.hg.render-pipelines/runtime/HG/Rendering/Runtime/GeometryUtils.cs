...
namespace HG.Rendering.Runtime
{
	internal static class GeometryUtils
	{
		public static bool Overlap(OrientedBBox obb, Frustum frustum, int numPlanes, int numCorners)
		{
			...
			//   __int128 v56; // xmm0
			//   __int128 v57; // xmm1
			//   __int64 v58; // [rsp+0h] [rbp-30h] BYREF
			//   int v59; // [rsp+8h] [rbp-28h]
			//   float extentX; // [rsp+Ch] [rbp-24h]
			//   __int64 v61; // [rsp+10h] [rbp-20h]
			//   int v62; // [rsp+18h] [rbp-18h]
			//   float v63; // [rsp+1Ch] [rbp-14h]
			//   __int64 v64; // [rsp+20h] [rbp-10h]
			//   unsigned __int64 v65; // [rsp+28h] [rbp-8h]
			//   Vector3 v66; // [rsp+30h] [rbp+0h] BYREF
			//   OrientedBBox v67; // [rsp+40h] [rbp+10h] BYREF
			//   float v68; // [rsp+70h] [rbp+40h]
			//   Vector3 v69; // [rsp+80h] [rbp+50h] BYREF
			//   Vector3 v70; // [rsp+90h] [rbp+60h] BYREF
			//   Vector3 v71; // [rsp+A0h] [rbp+70h] BYREF
			//   Vector3 v72; // [rsp+B0h] [rbp+80h] BYREF
			//   Vector3 v73; // [rsp+C0h] [rbp+90h] BYREF
			//   Frustum v74; // [rsp+D0h] [rbp+A0h] BYREF
			//   Vector3 v75; // [rsp+E0h] [rbp+B0h] BYREF
			//   Vector3 v76; // [rsp+F0h] [rbp+C0h] BYREF
			// 
			//   if ( !byte_18D919CCB )
			//   {
			//     sub_18003C530(&MethodInfo::HG::Rendering::Runtime::GeometryUtils::Overlap);
			//     byte_18D919CCB = 1;
			//   }
			...
			//     if ( !Patch )
			// LABEL_29:
			//       sub_180B536AC(planes, v9);
			//     v54 = *frustum;
			//     v65 = 0LL;
			//     v55 = *(_OWORD *)&obb.right.x;
			//     v74 = v54;
			//     LODWORD(v64) = numCorners;
			//     v56 = *(_OWORD *)&obb.up.x;
			//     *(_OWORD *)&v67.right.x = v55;
			//     v57 = *(_OWORD *)&obb.center.x;
			//     *(_OWORD *)&v67.up.x = v56;
			//     *(_OWORD *)&v67.center.x = v57;
			//     return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_182(Patch, &v67, &v74, numPlanes, numCorners, 0LL);
			//   }
			//   else
			//   {
			//     for ( i = 0; ; ++i )
			...
			//       if ( !frustum.planes )
			//         goto LABEL_29;
			//       v13 = sub_18003EB40(planes, i);
			//       planes = frustum.planes;
			//       v14 = *(_QWORD *)v13;
			//       v15 = *(float *)(v13 + 8);
			//       if ( !frustum.planes )
			//         goto LABEL_29;
			//       v16 = sub_18003EB40(planes, i);
			//       v17 = *(_OWORD *)&obb.center.x;
			//       v18 = *(_OWORD *)&obb.up.x;
			//       v69.z = v15;
			//       v19 = *(_OWORD *)&obb.right.x;
			//       v75.z = v15;
			//       *(_OWORD *)&v67.up.x = v18;
			//       v20 = *(_OWORD *)&obb.right.x;
			//       *(_OWORD *)&v67.center.x = v17;
			//       *(_QWORD *)&v76.x = v19;
			//       v21 = _mm_loadl_epi64((const __m128i *)&obb.right.z);
			//       *(_OWORD *)&v67.center.x = v17;
			//       *(_OWORD *)&v67.right.x = v20;
			//       v22 = v17;
			//       LODWORD(v76.z) = _mm_cvtsi128_si32(v21);
			//       v23 = *(_OWORD *)&obb.up.x;
			//       *(_OWORD *)&v67.right.x = *(_OWORD *)&obb.right.x;
			//       v24 = *(_OWORD *)&obb.up.x;
			//       *(_QWORD *)&v66.x = v23;
			//       v25 = _mm_loadl_epi64((const __m128i *)&obb.up.z);
			//       *(_OWORD *)&v67.up.x = v24;
			//       *(_QWORD *)&v69.x = v14;
			//       *(_OWORD *)&v67.center.x = v22;
			//       LODWORD(v66.z) = _mm_cvtsi128_si32(v25);
			//       *(_QWORD *)&v75.x = v14;
			//       forward = HG::Rendering::Runtime::OrientedBBox::get_forward((Vector3 *)&v74, obb, 0LL);
			//       v27 = *(_OWORD *)&obb.up.x;
			//       v71.z = v15;
			//       *(_QWORD *)&v71.x = v14;
			//       *(_QWORD *)&v22 = *(_QWORD *)&forward.x;
			//       *(float *)&forward = forward.z;
			//       *(_QWORD *)&v70.x = v22;
			//       v28 = *(_OWORD *)&obb.right.x;
			//       LODWORD(v70.z) = (_DWORD)forward;
			//       *(_OWORD *)&v67.up.x = v27;
			//       v73.z = v15;
			//       *(_OWORD *)&v67.right.x = v28;
			//       v29 = *(_OWORD *)&obb.center.x;
			//       *(_QWORD *)&v73.x = v14;
			//       *(_QWORD *)&v72.x = v29;
			//       LODWORD(v72.z) = _mm_cvtsi128_si32(_mm_loadl_epi64((const __m128i *)&obb.center.z));
			//       v31 = fabs(UnityEngine::Vector3::Dot(&v75, &v66, v30)) * obb.extentY;
			//       v33 = v31 + (float)(fabs(UnityEngine::Vector3::Dot(&v69, &v76, v32)) * obb.extentX);
			//       v35 = v33 + (float)(fabs(UnityEngine::Vector3::Dot(&v71, &v70, v34)) * obb.extentZ);
			//       if ( (float)(v35 + (float)(UnityEngine::Vector3::Dot(&v73, &v72, v36) + *(float *)(v16 + 12))) < 0.0 )
			//       {
			//         v11 = 0;
			//         break;
			//       }
			...
			//     if ( numCorners )
			//     {
			//       v37 = (const __m128i *)&v58;
			//       v64 = 0LL;
			//       v65 = 0LL;
			//       extentY = obb.extentY;
			//       v58 = *(_QWORD *)&obb.right.x;
			//       v59 = _mm_cvtsi128_si32(_mm_loadl_epi64((const __m128i *)&obb.right.z));
			//       extentX = obb.extentX;
			//       v61 = *(_QWORD *)&obb.up.x;
			//       v62 = _mm_cvtsi128_si32(_mm_loadl_epi64((const __m128i *)&obb.up.z));
			//       v63 = extentY;
			//       v39 = HG::Rendering::Runtime::OrientedBBox::get_forward((Vector3 *)&v74, obb, 0LL);
			//       planes = (Plane__Array *)LODWORD(v39.z);
			//       v64 = *(_QWORD *)&v39.x;
			//       v65 = __PAIR64__(LODWORD(obb.extentZ), (unsigned int)planes);
			//       if ( v11 )
			//       {
			//         v40 = 0LL;
			//         *(_QWORD *)&v66.x = 0LL;
			...
			//           if ( v40 >= 3 )
			//             break;
			//           v41 = (__m128)_mm_loadu_si128(v37);
			//           v42 = 0;
			//           v43 = 1;
			//           v44 = 1;
			//           if ( numCorners <= 0 )
			//             goto LABEL_25;
			//           v68 = COERCE_FLOAT(_mm_cvtsi128_si32(_mm_srli_si128((__m128i)v41, 8)));
			//           LODWORD(v45) = _mm_shuffle_ps(v41, v41, 255).m128_u32[0];
			//           do
			//           {
			//             if ( !frustum.corners )
			//               goto LABEL_29;
			//             sub_180040F70(frustum.corners, &v73, v42);
			//             v46 = *(_OWORD *)&obb.center.x;
			//             v71.z = v73.z;
			//             *(_QWORD *)&v72.x = v46;
			//             LODWORD(v72.z) = _mm_cvtsi128_si32(_mm_loadl_epi64((const __m128i *)&obb.center.z));
			//             *(_QWORD *)&v71.x = *(_QWORD *)&v73.x;
			//             v48 = UnityEngine::Vector3::op_Subtraction((Vector3 *)&v74, &v71, &v72, v47);
			//             *(_QWORD *)&v69.x = v41.m128_u64[0];
			//             v49 = *(_QWORD *)&v48.x;
			//             v70.z = v48.z;
			//             v69.z = v68;
			//             *(_QWORD *)&v70.x = v49;
			//             v51 = UnityEngine::Vector3::Dot(&v69, &v70, v50);
			//             if ( v43 )
			//               v43 = v51 > v45;
			//             if ( v44 )
			//               v44 = (float)-v51 > v45;
		...
		public static Vector4 Plane(Vector3 position, Vector3 normal)
		{
			...
			//     *(_QWORD *)&v19.x = v15;
			//     v19.z = v16;
			//     *retstr = *IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_183(&v18, Patch, &v19, &v20, 0LL);
			//   }
			//   else
			//   {
			//     v8 = position.z;
		...
		public static Vector4 CameraSpacePlane(Matrix4x4 worldToCamera, Vector3 positionWS, Vector3 normalWS, [MetadataOffset(Offset = "0x01F90B85")] float sideSign = 1f, [MetadataOffset(Offset = "0x01F90B89")] float clipPlaneOffset = 0f)
		{
			...
			//   {
			//     Patch = IFix::WrappersManagerImpl::GetPatch(390, 0LL);
			//     if ( !Patch )
			...
			//     *(_OWORD *)&v41.m02 = v35;
			//     *(_OWORD *)&v41.m03 = v36;
			//     *retstr = *IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_184(
			//                  &v38,
			//                  Patch,
			//                  &v41,
			//                  &v39,
		...
		public static Matrix4x4 CalculateWorldToCameraMatrixRHS(Vector3 position, Quaternion rotation)
		{
			...
			//   if ( !wrapperArray )
			//     goto LABEL_11;
			//   if ( wrapperArray.max_length.size > 391 )
			//   {
			...
			//     if ( v7 )
			//     {
			//       if ( LODWORD(v7._0.namespaze) <= 0x187 )
			...
			//         v34 = v24;
			//         *(_QWORD *)&v33.x = v25;
			//         v26 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_185(&v44, Patch, &v33, &v34, 0LL);
			//         v27 = *(_OWORD *)&v26.m01;
			...
			//   v16 = (void (__fastcall *)(Quaternion *, Quaternion *, Vector3 *, __int128 *))qword_18D8F4BC8;
			//   v43 = v15;
			//   v33.z = 1.0;
			//   *(_QWORD *)&v34.x = v14;
			//   v35 = 0LL;
			...
			//   if ( !qword_18D8F4BC8 )
			//   {
			//     v16 = (void (__fastcall *)(Quaternion *, Quaternion *, Vector3 *, __int128 *))il2cpp_resolve_icall_0(
			...
			//     }
			//     qword_18D8F4BC8 = (__int64)v16;
			//   }
			//   v16(&v34, &v43, &v33, &v35);
			//   v17 = (void (__fastcall *)(_OWORD *, __int128 *))qword_18D8F4BD0;
			//   v45[0] = v35;
			//   v45[1] = v36;
			//   v45[2] = v37;
			//   v45[3] = v38;
			...
			//   if ( !qword_18D8F4BD0 )
			//   {
			//     v17 = (void (__fastcall *)(_OWORD *, __int128 *))il2cpp_resolve_icall_0(
			//                                                        "UnityEngine.Matrix4x4::Inverse_Injected(UnityEngine.Matrix4x4&,Un"
			//                                                        "ityEngine.Matrix4x4&)");
			//     if ( !v17 )
			//     {
			//       v31 = sub_1802DBBE8("UnityEngine.Matrix4x4::Inverse_Injected(UnityEngine.Matrix4x4&,UnityEngine.Matrix4x4&)");
			//       sub_18000F750(v31, 0LL);
			//     }
			//     qword_18D8F4BD0 = (__int64)v17;
			//   }
			//   v17(v45, &v39);
			//   v18 = (void (__fastcall *)(Matrix4x4 *, _OWORD *, __int128 *))qword_18D8F4BC0;
			//   *(_OWORD *)&v44.m00 = v10;
			//   v46[0] = v39;
			//   *(_OWORD *)&v44.m01 = v11;
			//   *(_OWORD *)&v44.m02 = v12;
			...
			//   if ( !qword_18D8F4BC0 )
			//   {
			//     v18 = (void (__fastcall *)(Matrix4x4 *, _OWORD *, __int128 *))il2cpp_resolve_icall_0(
		...
		public static Matrix4x4 CalculateWorldToCameraMatrixRHS(Transform transform)
		{
			...
			//     if ( Patch )
			//     {
			//       v20 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_186(v29, Patch, (Object *)transform, 0LL);
			//       goto LABEL_7;
			//     }
			// LABEL_5:
			//     sub_180B536AC(v7, v6);
		...
		public static Matrix4x4 CalculateObliqueMatrix(Matrix4x4 sourceProjection, Vector4 clipPlane)
		{
			...
			//     *(_OWORD *)&v44.m02 = v34;
			//     *(_OWORD *)&v44.m03 = v35;
			//     v36 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_187(v46, Patch, &v44, &v41, 0LL);
			//     v37 = *(_OWORD *)&v36.m01;
		...
		public static Matrix4x4 CalculateReflectionMatrix(Vector3 position, Vector3 normal)
		{
			...
			//     *(_QWORD *)&v20.x = v14;
			//     v20.z = v15;
			//     v10 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_189(&v23, Patch, &v20, (Vector3 *)&v21, 0LL);
			//   }
			//   else
			//   {
			//     v7 = sub_182413270(&v21, normal);
			//     v8 = *(_QWORD *)v7;
		...
		public static Matrix4x4 CalculateReflectionMatrix(Vector4 plane)
		{
			...
			// 
			//   if ( IFix::WrappersManagerImpl::IsPatched(395, 0LL) )
			//   {
			//     Patch = IFix::WrappersManagerImpl::GetPatch(395, 0LL);
			//     if ( !Patch )
			//       sub_180B536AC(v11, v10);
			//     v15 = *plane;
			//     v12 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_188(&v16, Patch, &v15, 0LL);
			//     v13 = *(_OWORD *)&v12.m01;
		...
		public static bool IsProjectionMatrixOblique(Matrix4x4 projectionMatrix)
		{
			...
			//     if ( v3 )
			//     {
			//       if ( LODWORD(v3._0.namespaze) <= 0x18C )
			...
			//         *(_OWORD *)&v10.m02 = v8;
			//         *(_OWORD *)&v10.m03 = v9;
			//         return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_190(Patch, &v10, 0LL);
			//       }
			//     }
			// LABEL_10:
		...
		public static Matrix4x4 CalculateProjectionMatrix(Camera camera)
		{
			...
			//     if ( Patch )
			//     {
			//       v11 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_186(&v22, Patch, (Object *)camera, 0LL);
			//       goto LABEL_9;
			//     }
			// LABEL_7:
			//     sub_180B536AC(v6, v5);
		...
		public static void IntersectPlanePlane(float4 plane1, float4 plane2, out float3 rayOrigin, out float3 rayDirection)
		{
			...
			//     v64 = *plane2;
			//     v63 = v59;
			//     IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_191(Patch, &v63, &v64, rayOrigin, rayDirection, 0LL);
			//   }
			//   else
			//   {
			...
			//     v24 = sub_182345040(&v64, &vector, &value, v23);
		...
		public static bool IntersectSpherePlaneBounds(float3 sphereCenter, float radius, float3 frustumApex, float3 frustumOrientation, float4 left, float4 right, float4 bottom, float4 top, float3 leftBottom, float3 leftTop, float3 rightBottom, float3 rightTop)
		{
			...
			//   return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_193(
			//            Patch,
			//            (float3 *)&vector,
			//            radius,
			//            (float3 *)&v105,
		...
		public static bool IntersectSphereParallelPlanes(float3 sphereCenter, float radius, float3 normal, float frontPlaneDistance, float backPlaneDistance)
		{
			...
			// 
			//   if ( IFix::WrappersManagerImpl::IsPatched(401, 0LL) )
			//   {
		...
		public static bool IntersectRaySphere(float3 rayOrigin, float3 rayDirection, float3 sphereCenter, float radius, [MetadataOffset(Offset = "0x01F90B8D")] bool normalize = false)
		{
			...
			//     return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_192(
			//              Patch,
			//              &v35,
			//              (float3 *)&vector,
			//              (float3 *)&value,
