...
{
	public class HGFoliageInteractRaft : HGFoliageInteract
	{
		public HGFoliageInteractRaft()
		{
		...
		public Vector3 GetRaftCenterPosition()
		{
			...
			//     if ( Patch )
			//     {
			//       position = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_328(v14, Patch, (Object *)this, 0LL);
			//       goto LABEL_8;
			//     }
			// LABEL_6:
			//     sub_180B536AC(v7, v6);
		...
		public Vector3 GetCapsuleProxyPositionA()
		{
			...
			// 
			//   if ( IFix::WrappersManagerImpl::IsPatched(872, 0LL) )
			//   {
			//     Patch = IFix::WrappersManagerImpl::GetPatch(872, 0LL);
			//     if ( Patch )
			//     {
			//       v23 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_328(v30, Patch, (Object *)this, 0LL);
			//       goto LABEL_10;
			//     }
			// LABEL_8:
			//     sub_180B536AC(v7, v6);
		...
		public Vector3 GetCapsuleProxyPositionB()
		{
			...
			//   Vector3 v30[2]; // [rsp+40h] [rbp-40h] BYREF
			// 
			//   if ( IFix::WrappersManagerImpl::IsPatched(875, 0LL) )
			//   {
			//     Patch = IFix::WrappersManagerImpl::GetPatch(875, 0LL);
			//     if ( Patch )
			//     {
			//       v23 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_328(v30, Patch, (Object *)this, 0LL);
			//       goto LABEL_10;
		...
		public float GetCapsuleProxyRadius()
		{
			...
			// 
			//   if ( !IFix::WrappersManagerImpl::IsPatched(874, 0LL) )
			//   {
			//     transform = UnityEngine::Component::get_transform((Component *)this, 0LL);
			//     if ( transform )
			//     {
			...
			//     sub_180B536AC(v5, v4);
			//   }
			//   Patch = IFix::WrappersManagerImpl::GetPatch(874, 0LL);
			//   if ( !Patch )
			//     goto LABEL_6;
		...
		private float GetCapsuleProxyHalfLength()
		{
			...
			// 
			//   if ( !IFix::WrappersManagerImpl::IsPatched(873, 0LL) )
			//   {
			//     transform = UnityEngine::Component::get_transform((Component *)this, 0LL);
			//     if ( transform )
			...
			//     sub_180B536AC(v5, v4);
			//   }
			//   Patch = IFix::WrappersManagerImpl::GetPatch(873, 0LL);
			//   if ( !Patch )
			//     goto LABEL_5;
			//   return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_43((ILFixDynamicMethodWrapper_16 *)Patch, (Object *)this, 0LL);
			// }
		...
		private void OnEnable()
		{
			...
			//   __int64 v18; // rdx
			//   __int64 v19; // rcx
			//   HGFoliageInteractRaftCPP v20; // [rsp+20h] [rbp-19h] BYREF
			//   HGFoliageInteractCPP v21; // [rsp+38h] [rbp-1h] BYREF
			//   HGFoliageInteractCPP interact; // [rsp+50h] [rbp+17h] BYREF
			//   HGFoliageInteractRaftCPP raft; // [rsp+70h] [rbp+37h] BYREF
			// 
			//   *(&v20.compID + 1) = 0;
			//   v20.interactCollider = 0LL;
			...
			//       this,
			//       0LL);
			//     v21.interactCollider = 0LL;
			//     *(_QWORD *)&v21.compID = (unsigned int)UnityEngine::Object::GetInstanceID((Object_1 *)this, 0LL);
			//     v21.transform = UnityEngine::Component::get_transform((Component *)this, 0LL);
			//     sub_1800054D0(
			//       (OneofDescriptor *)&v21.transform,
			//       v7,
			//       v8,
			//       v9,
			//       *(String__Array **)&v20.compID,
			//       (String *)v20.transform,
			//       (MethodInfo *)v20.interactCollider);
			//     v21.interactCollider = this.fields._.interactiveCollider;
			//     sub_1800054D0(
			//       (OneofDescriptor *)&v21.interactCollider,
			//       v10,
			//       v11,
			//       (MessageDescriptor *)v21.interactCollider,
			//       *(String__Array **)&v20.compID,
			//       (String *)v20.transform,
			//       (MethodInfo *)v20.interactCollider);
			//     interact = v21;
			...
			//     v20.interactCollider = 0LL;
			//     *(_QWORD *)&v20.compID = (unsigned int)UnityEngine::Object::GetInstanceID((Object_1 *)this, 0LL);
			//     v20.transform = UnityEngine::Component::get_transform((Component *)this, 0LL);
			//     ((void (__stdcall *)(OneofDescriptor *, OneofDescriptorProto *, FileDescriptor *, MessageDescriptor *, String__Array *))sub_1800054D0)(
			//       (OneofDescriptor *)&v20.transform,
			//       v12,
			//       v13,
			//       v14,
			//       *(String__Array **)&v20.compID);
			//     v20.interactCollider = this.fields._.interactiveCollider;
			//     ((void (__stdcall *)(OneofDescriptor *, OneofDescriptorProto *, FileDescriptor *, MessageDescriptor *, String__Array *, String *))sub_1800054D0)(
			//       (OneofDescriptor *)&v20.interactCollider,
			//       v15,
			//       v16,
			//       (MessageDescriptor *)v20.interactCollider,
			//       *(String__Array **)&v20.compID,
			//       (String *)v20.transform);
			//     raft = v20;
