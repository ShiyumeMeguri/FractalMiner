...
{
	public class HGSludgeManager // TypeDefIndex: 37679
	{
		// Fields
		private HGSludgeConfig m_config; // 0x10
		private int m_dynamicSludgeGUID; // 0x1C
		private Dictionary<int, HGDynamicSludge> m_dynamicSludges; // 0x20
		private List<int> m_cacheOutDateList; // 0x28
		private AtlasMaxRect m_atlasMaxRect; // 0x30
		private Mesh m_planeMesh; // 0x38
	
		// Constructors
		public HGSludgeManager() {} // 0x0000000182ED8000-0x0000000182ED8110
		// HGSludgeManager()
		void HG::Rendering::Runtime::HGSludgeManager::HGSludgeManager(HGSludgeManager *this, MethodInfo *method)
		{
		  ...
		  HGSludgeConfig v26[2]; // [rsp+20h] [rbp-18h] BYREF
		  MethodInfo *v27; // [rsp+60h] [rbp+28h]
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1614, 0LL) )
		  {
		    ...
		    if ( !Patch )
		      goto LABEL_4;
		    v25 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_652(v26, Patch, 0LL);
		    textureSize = v25->textureSize;
		    graphicsFormat = v25->graphicsFormat;
		  }
		  else
		  {
		    v26[0].textureSize = (Vector2Int)0x10000000100LL;
		    graphicsFormat = 21;
		  ...
		  v5 = (Dictionary_2_System_Int32_System_Object_ *)sub_1800368D0(TypeInfo::System::Collections::Generic::Dictionary<int,HG::Rendering::Runtime::Sludge::HGDynamicSludge>);
		  ...
		  sub_18002D1B0(
		    (HGRuntimeGrassQuery_Node *)&this->fields.m_dynamicSludges,
		    v9,
		    v10,
		    v11,
		    *(MethodInfo **)&v26[0].textureSize);
		  m_X = this->fields.m_config.textureSize.m_X;
		  m_Y = this->fields.m_config.textureSize.m_Y;
		  v14 = (AtlasMaxRect *)sub_1800368D0(TypeInfo::HG::Rendering::Runtime::AtlasMaxRect);
		  v15 = v14;
		  if ( !v14
		    || (HG::Rendering::Runtime::AtlasMaxRect::AtlasMaxRect(v14, m_X, m_Y, 0LL),
		        this->fields.m_atlasMaxRect = v15,
		        sub_18002D1B0(
		          (HGRuntimeGrassQuery_Node *)&this->fields.m_atlasMaxRect,
		          v16,
		          v17,
		          v18,
		          *(MethodInfo **)&v26[0].textureSize),
		...
		LABEL_4:
		  ...
		  sub_18002D1B0((HGRuntimeGrassQuery_Node *)&this->fields.m_cacheOutDateList, v21, v22, v23, v27);
		}
		
	
		// Methods
		public float GetTime() => default; // 0x0000000189CF4A88-0x0000000189CF4AE4
		// Single GetTime()
		float HG::Rendering::Runtime::HGSludgeManager::GetTime(HGSludgeManager *this, MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1615, 0LL) )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(1615, 0LL);
		    if ( !Patch )
		      sub_1800D8260(v6, v5);
		...
		public void Initialize(Mesh planeMesh) {} // 0x0000000183945610-0x0000000183945650
		// Void Initialize(Mesh)
		void HG::Rendering::Runtime::HGSludgeManager::Initialize(HGSludgeManager *this, Mesh *planeMesh, MethodInfo *method)
		{
		  ...
		  {
		    this->fields.m_planeMesh = planeMesh;
		    sub_18002D1B0((HGRuntimeGrassQuery_Node *)&this->fields.m_planeMesh, v5, v6, v7, v11);
		  }
		}
		
		public void Dispose() {} // 0x0000000189CF4660-0x0000000189CF46D0
		// Void Dispose()
		void HG::Rendering::Runtime::HGSludgeManager::Dispose(HGSludgeManager *this, MethodInfo *method)
		{
		  __int64 v3; // rdx
		  Dictionary_2_Beyond_Gameplay_Core_WaterVolumePtr_System_ValueTuple_3_Single_Int32Enum_Object_ *m_dynamicSludges; // rcx
		  ILFixDynamicMethodWrapper_2 *Patch; // rax
		
		  if ( !IFix::WrappersManagerImpl::IsPatched(1617, 0LL) )
		  {
		    m_dynamicSludges = (Dictionary_2_Beyond_Gameplay_Core_WaterVolumePtr_System_ValueTuple_3_Single_Int32Enum_Object_ *)this->fields.m_dynamicSludges;
		    if ( m_dynamicSludges )
		    {
		      ...
		      m_dynamicSludges = (Dictionary_2_Beyond_Gameplay_Core_WaterVolumePtr_System_ValueTuple_3_Single_Int32Enum_Object_ *)this->fields.m_atlasMaxRect;
		      if ( m_dynamicSludges )
		      {
		...
		LABEL_6:
		    sub_1800D8260(m_dynamicSludges, v3);
		  }
		...
		public void GameplayUpdate() {} // 0x00000001832E26E0-0x00000001832E29D0
		// Void GameplayUpdate()
		...
		void HG::Rendering::Runtime::HGSludgeManager::GameplayUpdate(HGSludgeManager *this, MethodInfo *method)
		{
		  ...
		  Dictionary_2_System_UInt64_System_Object_ *dictionary; // rcx
		  ...
		  Dictionary_2_System_UInt64_System_Object_ *v20; // r9
		  __int64 v21; // r9
		  ...
		  List_1_T_Enumerator_System_Int32_ v24; // [rsp+48h] [rbp-80h] BYREF
		  ...
		  if ( wrapperArray->max_length.size <= 1619 )
		    goto LABEL_12;
		  ...
		  if ( !v5 )
		    sub_1800D8260(v3, method);
		  if ( v5->max_length.size <= 0x653u )
		    sub_1800D2AB0(v3, method);
		  if ( v5[45].max_length.value )
		  {
		...
		LABEL_12:
		    ...
		    if ( m_dynamicSludges->fields._count != m_dynamicSludges->fields._freeCount )
		    {
		      ...
		      System::Collections::Generic::Dictionary<unsigned long,System::Object>::GetEnumerator(
		        (Dictionary_2_TKey_TValue_Enumerator_System_UInt64_System_Object_ *)&v23,
		        (Dictionary_2_System_UInt64_System_Object_ *)v2->fields.m_dynamicSludges,
		      ...
		      *(_QWORD *)&v23._version = &v25;
		      ...
		      {
		        v11 = (HGRuntimeGrassQuery_Node *)&v22;
		        v23._dictionary = (Dictionary_2_System_Int32Enum_System_Object_ *)v26->ex;
		        dictionary = (Dictionary_2_System_UInt64_System_Object_ *)v23._dictionary;
		        if ( v23._dictionary )
		          sub_18007E1E0(v23._dictionary);
		        v2 = this;
		      }
		      v20 = (Dictionary_2_System_UInt64_System_Object_ *)v2->fields.m_cacheOutDateList;
		      if ( !v20 )
		        sub_1800D8250(dictionary, v11);
		...
		public Mesh GetPlaneMesh() => default; // 0x0000000189CF49A4-0x0000000189CF49F4
		// Mesh GetPlaneMesh()
		...
		public bool HasActiveSludge() => default; // 0x0000000189CF4AE4-0x0000000189CF4B44
		...
		bool HG::Rendering::Runtime::HGSludgeManager::HasActiveSludge(HGSludgeManager *this, MethodInfo *method)
		{
		  ...
		  if ( !IFix::WrappersManagerImpl::IsPatched(1629, 0LL) )
		  {
		...
		LABEL_5:
		  ...
		  Patch = IFix::WrappersManagerImpl::GetPatch(1629, 0LL);
		  if ( !Patch )
		    goto LABEL_5;
		  return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_14((ILFixDynamicMethodWrapper_20 *)Patch, (Object *)this, 0LL);
		}
		
		public void GetActiveDynamicSludgePassData(List<HGDynamicSludgePassData> result, float lastTime) {} // 0x0000000189CF46D0-0x0000000189CF4934
		        ...
		        MethodInfo *method)
		{
		  ...
		  else
		  {
		    ...
		    if ( !this->fields.m_dynamicSludges )
		      sub_1800D8260(v7, v6);
		    System::Collections::Generic::Dictionary<unsigned long,System::Object>::GetEnumerator(
		      (Dictionary_2_TKey_TValue_Enumerator_System_UInt64_System_Object_ *)&v21,
		      (Dictionary_2_System_UInt64_System_Object_ *)this->fields.m_dynamicSludges,
		      MethodInfo::System::Collections::Generic::Dictionary<int,HG::Rendering::Runtime::Sludge::HGDynamicSludge>::GetEnumerator);
		    v19 = v21;
		    try
		    {
		...
		public HGSludgeConfig GetConfig() => default; // 0x0000000189CF4934-0x0000000189CF49A4
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1631, 0LL) )
		  {
		    ...
		    if ( !Patch )
		      sub_1800D8260(v9, v8);
		    v10 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_657(v12, Patch, (Object *)this, 0LL);
		...
		public int RequireDynamicSludge(Vector2Int texelSize, float rebornTime, float rebornAnimTime) => default; // 0x0000000189CF4D20-0x0000000189CF4F94
		        ...
		        MethodInfo *method)
		{
		  ...
		  m_Y = texelSize.m_Y;
		  if ( !IFix::WrappersManagerImpl::IsPatched(1632, 0LL) )
		  {
		    v7 = this->fields.m_dynamicSludgeGUID + 1;
		    this->fields.m_dynamicSludgeGUID = v7;
		    key = v7;
		    v8 = sub_18002C620(TypeInfo::HG::Rendering::Runtime::Sludge::HGDynamicSludge);
		    v11 = v8;
		    if ( v8 )
		    {
		...
		LABEL_7:
		    sub_1800D8260(m_dynamicSludges, m_atlasMaxRect);
		  }
		  Patch = IFix::WrappersManagerImpl::GetPatch(1632, 0LL);
		  if ( !Patch )
		    goto LABEL_7;
		  return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_660(
		           Patch,
		           (Object *)this,
		           texelSize,
		           rebornTime,
		...
		public Vector4 GetTillingScale(int handle) => default; // 0x0000000189CF49F4-0x0000000189CF4A88
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1638, 0LL) )
		  {
		    Patch = IFix::WrappersManagerImpl::GetPatch(1638, 0LL);
		    if ( Patch )
		    {
		      v10 = *IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_661(&v13, Patch, (Object *)this, handle, 0LL);
		      goto LABEL_8;
		    }
		LABEL_6:
		    sub_1800D8260(m_dynamicSludges, v7);
		  }
		  m_dynamicSludges = this->fields.m_dynamicSludges;
		  if ( !m_dynamicSludges )
		    goto LABEL_6;
		...
		public void HitPosition(int handle, Vector2 uvPoint, float range) {} // 0x0000000189CF4B44-0x0000000189CF4C68
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( !IFix::WrappersManagerImpl::IsPatched(1639, 0LL) )
		  {
		    m_dynamicSludges = this->fields.m_dynamicSludges;
		    if ( m_dynamicSludges )
		    {
		...
		LABEL_6:
		    sub_1800D8260(m_dynamicSludges, v8);
		  }
		  Patch = IFix::WrappersManagerImpl::GetPatch(1639, 0LL);
		  if ( !Patch )
		    goto LABEL_6;
		  IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_662(Patch, (Object *)this, handle, uvPoint, range, 0LL);
		}
		
		public void ReleaseDynamicSludge(int handle) {} // 0x0000000189CF4C68-0x0000000189CF4D20
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( !IFix::WrappersManagerImpl::IsPatched(1620, 0LL) )
		  {
		...
		LABEL_10:
		    sub_1800D8260(m_dynamicSludges, v5);
		  }
		  Patch = IFix::WrappersManagerImpl::GetPatch(1620, 0LL);
		  if ( !Patch )
		    goto LABEL_10;
		  IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_3((ILFixDynamicMethodWrapper_29 *)Patch, (Object *)this, handle, 0LL);
		}
