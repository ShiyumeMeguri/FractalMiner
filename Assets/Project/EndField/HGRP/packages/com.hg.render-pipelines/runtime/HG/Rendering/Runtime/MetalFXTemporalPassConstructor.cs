...
namespace HG.Rendering.Runtime
{
	...
	{
		internal MetalFXTemporalPassConstructor(HGRenderPathBase.HGRenderPathResources resources)
		{
		...
		internal void ConstructPass(ref MetalFXTemporalPassConstructor.PassInput input, ref MetalFXTemporalPassConstructor.PassOutput output, HGRenderGraph renderGraph, HGCamera camera)
		{
			...
			//   if ( !byte_18D91958B )
			//   {
			//     sub_18003C530(&MethodInfo::HG::Rendering::RenderGraphModule::HGRenderGraphBuilder::SetRenderFunc<HG::Rendering::Runtime::MetalFXTemporalPassConstructor::MetalFXTemporalPassData>);
			//     sub_18003C530(&MethodInfo::HG::Rendering::RenderGraphModule::HGRenderGraph::AddRenderPass<HG::Rendering::Runtime::MetalFXTemporalPassConstructor::MetalFXTemporalPassData>);
			//     sub_18003C530(&TypeInfo::HG::Rendering::Runtime::MetalFXTemporalPassConstructor);
			//     sub_18003C530(&MethodInfo::UnityEngine::Rendering::ProfilingSampler::Get<HG::Rendering::Runtime::HGProfileId>);
			//     sub_18003C530(&off_18D500F78);
			//     sub_18003C530(&off_18D500F80);
			//     byte_18D91958B = 1;
			//   }
			//   v55 = 0LL;
			...
			//     IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_994(
			//       Patch,
			//       (Object *)this,
			//       input,
			//       output,
			...
			//           _m_prefetchw(&qword_18D6870D0[v23]);
			//           do
			//             v24 = qword_18D6870D0[v23];
			...
			//             if ( !v55 )
			//               sub_1802DC2C8(m_temporalScalerHandle, v33);
			...
			//             sub_180002C70(TypeInfo::HG::Rendering::Runtime::MetalFXTemporalPassConstructor);
		...
		private bool m_prevTemporalScalerState;

		private MetalFXTemporalPassConstructor.MetalFXTemporalScalerDesc m_temporalScalerDesc;

		private uint m_temporalScalerHandle;

		[StaticFieldOffset(ThreadStatic = false, Offset = "0x00")]
		private static readonly RenderFunc<MetalFXTemporalPassConstructor.MetalFXTemporalPassData> s_metalFXTemporalRenderFunc;
		...
		private class MetalFXTemporalPassData
		{
			public MetalFXTemporalPassData()
			{
				// // Void Lerp[HGWindConfig](HGWindConfig ByRef, HGWindConfig ByRef, Single)
				// void HG::Rendering::Runtime::HGCelestialConfig::HGCelestialAdvancedObjectConfig::Lerp<HG::Rendering::Runtime::HGWindConfig>(
				//         HGCelestialConfig_HGCelestialAdvancedObjectConfig *this,
			...
			internal uint temporalScalerHandle;
			...
			internal float jitterOffsetX;

			internal float jitterOffsetY;
		}

		[StructLayout(LayoutKind.Sequential, Pack = 1, Size = 32)]
		internal struct MetalFXTemporalScalerDesc : IEquatable<MetalFXTemporalPassConstructor.MetalFXTemporalScalerDesc>
		{
			public bool Equals(MetalFXTemporalPassConstructor.MetalFXTemporalScalerDesc other)
			{
				...
				//   return IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_993(Patch, this, &v10, 0LL);
				// }
				// 
				return default(bool);
			}
			...
			internal GraphicsFormat depthTextureFormat;

			internal GraphicsFormat motionTextureFormat;
