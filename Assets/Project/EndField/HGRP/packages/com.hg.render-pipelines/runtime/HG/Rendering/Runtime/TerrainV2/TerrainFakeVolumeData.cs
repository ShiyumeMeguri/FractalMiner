...
namespace HG.Rendering.Runtime.TerrainV2
{
	...
	public struct TerrainFakeVolumeData
	{
		public void SetupTerrainParams(HGRenderGraphContext context)
		{
			...
			//   if ( !Patch )
			//     goto LABEL_8;
			//   IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_1375(Patch, this, (Object *)context, 0LL);
			// }
			// 
		}
		...
		public HGTerrainFakeVolumeData ToDataCPP()
		{
			...
			//       if ( Patch )
			//       {
			//         v25 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_1376(&v37, Patch, this, 0LL);
			//         goto LABEL_38;
			//       }
			//       goto LABEL_40;
			//     }
			//   }
			//   sub_1802F01E0(&v37, 0LL, 164LL);
		...
		public TerrainFakeVolumeParams _Params;

		public Texture2D _FakeVolumeOpacityMask;

		public Texture2D _FakeVolumeMask;
	}
}
