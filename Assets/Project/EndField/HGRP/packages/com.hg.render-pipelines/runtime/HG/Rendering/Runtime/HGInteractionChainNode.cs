...
{
	public struct HGInteractionChainNode // TypeDefIndex: 37740
	{
		// Fields
		public Vector2 VRange; // 0x00
		public int SectionIndex; // 0x08
		public Vector2 HeightFade; // 0x0C
		public Vector4 TimeFade; // 0x14
		public Vector2 StartDist; // 0x24
		public Vector3 Position; // 0x2C
		public Quaternion Rotation; // 0x38
		public Vector2 Scale; // 0x48
		public Vector3 Vertex0; // 0x50
		public Vector3 Vertex1; // 0x5C
		public Vector3 Vertex2; // 0x68
		public Vector3 Vertex3; // 0x74
		public bool Active; // 0x80
	
		// Properties
		public static HGInteractionChainNode DefaultValue { get => default; } // 0x0000000189CFC068-0x0000000189CFC1F8 
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1778, 0LL) )
		  {
		    ...
		    v29 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_714(&v43, Patch, 0LL);
		  }
		  else
		  {
		    sub_18033B9D0(&v43, 0LL, 132LL);
		    v43.VRange.x = 0.0;
		    v43.VRange.y = 0.0;
		    v43.SectionIndex = -1;
		    v43.HeightFade.x = 0.0;
		    *(__m128i *)&v43.HeightFade.y = _mm_load_si128((const __m128i *)&xmmword_18DA45B40);
		    v43.TimeFade.w = 1.0;
		    v43.StartDist.x = -1.0;
		    v43.StartDist.y = -1.0;
		...
		// Methods
		public Matrix4x4 GetMatrix() => default; // 0x0000000189CFBF7C-0x0000000189CFC068
		// Matrix4x4 GetMatrix()
		        ...
		        MethodInfo *method)
		{
		  ...
		  if ( IFix::WrappersManagerImpl::IsPatched(1779, 0LL) )
		  {
		    ...
		    v9 = IFix::ILFixDynamicMethodWrapper::__Gen_Wrap_715(&v20, Patch, this, 0LL);
		  }
		  else
		  {
		    v5 = sub_186351688(
