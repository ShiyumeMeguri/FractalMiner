...
float ShadowStrength=0;             
    ...
    SDFMask_octNormal_Diffuse.xyzw = tex2Dlod(_IN1, float4(v0.xy, 0, 0)).wxyz;
        ...
        diffuse = SDFMask_octNormal_Diffuse.z;
        sceneNormal = SDFMask_octNormal_Diffuse.yzw;
    ...
    if (shadowColor_ShadeModeOutputMask.w != 0) {
        ...
        r4.zw = SDFMask_octNormal_Diffuse.yz * float2(2,2) + float2(-1,-1);
    ...
    if (cb1[255].x != 0) {
        ...
        InTex4.x = saturate(SDFMask_octNormal_Diffuse.w + SDFMask_octNormal_Diffuse.w);
        r4.w = InTex4.x * -2 + 3;
        InTex4.x = InTex4.x * InTex4.x;
        InTex4.x = r4.w * InTex4.x;
        r4.w = -0.5 + SDFMask_octNormal_Diffuse.w;
        ...
        SDFMask_octNormal_Diffuse.x = saturate(SDFMask_octNormal_Diffuse.w + SDFMask_octNormal_Diffuse.w);
        ...
        InTex4.x = -0.5 + SDFMask_octNormal_Diffuse.w;
    ...
    SDFMask_octNormal_Diffuse.x = -0.400000006 + SDFMask_octNormal_Diffuse.w;
