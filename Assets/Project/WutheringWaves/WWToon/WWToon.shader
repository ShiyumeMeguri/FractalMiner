...
float4 frag (VertexToFragment fragmentInput) : SV_Target
{
    ...
    float4 normal_perObjectData = 0, msr_shadingModelID = 0, albedo_alpha = 0, customData = 0, r4 = 0, r5 = 0, r6 = 0, r7 = 0, r8 = 0, r9 = 0, r10 = 0, r11 = 0, r12 = 0, r13 = 0, r14 = 0, r15 = 0, r16 = 0;
...
float4 fDest = 0;
    ...
    albedo_alpha.w = tex2Dlod(_IN0, float4(screenUV_ndcUV.xy, 0, 0)).x;
    customData.w = albedo_alpha.w * cb1[65].x + cb1[65].y;
    albedo_alpha.w = albedo_alpha.w * cb1[65].z + -cb1[65].w;
    albedo_alpha.w = 1 / albedo_alpha.w;
    albedo_alpha.w = customData.w + albedo_alpha.w;
    uint2 uv_scaled = cb1[138].xy * screenUV_ndcUV.xy;
    uv_scaled = (uint2)uv_scaled.xy;
    customData.w = (uint)cb1[158].x;
    uv_scaled.x = (int)uv_scaled.y + (int)uv_scaled.x;
    customData.w = (int)customData.w + (int)uv_scaled.x;
    customData.w = (int)customData.w & 1;
    msr_shadingModelID.w = 255 * msr_shadingModelID.w;
    msr_shadingModelID.w = round(msr_shadingModelID.w);
    msr_shadingModelID.w = (uint)msr_shadingModelID.w;
    r4.xy = (int2)msr_shadingModelID.ww & int2(15,-16);
    msr_shadingModelID.w = ((int)r4.x != 12) ? 1.0 : 0.0;
    r5.xyz = ((int3)r4.xxx == int3(13,14,15)) ? 1.0 : 0.0;
    r4.z = (int)r5.z | (int)r5.y;
    r4.z = (int)r4.z | (int)r5.x;
    msr_shadingModelID.w = msr_shadingModelID.w ? r4.z : -1;
    if (msr_shadingModelID.w != 0) {
        r4.x = r5.x ? 13 : 12;
        r5.xz = r5.yz ? float2(1,1) : 0;
        r4.zw = normal_perObjectData.yz * float2(2,2) + float2(-1,-1);
        msr_shadingModelID.w = dot(float2(1,1), abs(r4.zw));
        r6.z = 1 + -msr_shadingModelID.w;
        msr_shadingModelID.w = max(0, -r6.z);
        r7.xy = (r4.zw >= float2(0,0)) ? 1.0 : 0.0;
        r7.xy = r7.xy ? float2(0.5,0.5) : float2(-0.5,-0.5);
        r7.xy = r7.xy * msr_shadingModelID.ww;
        r6.xy = r7.xy * float2(-2,-2) + r4.zw;
        msr_shadingModelID.w = dot(r6.xyz, r6.xyz);
        msr_shadingModelID.w = rsqrt(msr_shadingModelID.w);
        r6.xyz = r6.xyz * msr_shadingModelID.www;
        r7.xyz = msr_shadingModelID.xyz * msr_shadingModelID.xyz;
        r5.y = customData.z;
    } else {
        msr_shadingModelID.w = ((int)r4.x == 10) ? 1.0 : 0.0;
        ...
        albedo_alpha.w = msr_shadingModelID.w ? msr_shadingModelID.x : albedo_alpha.w;
    ...
    normal_perObjectData.yz = ((int2)r4.xx == int2(5,13)) ? 1.0 : 0.0;
    msr_shadingModelID.w = (0 < cb1[162].y) ? 1.0 : 0.0;
    r4.z = (0 < cb1[220].z) ? 1.0 : 0.0;
    msr_shadingModelID.w = msr_shadingModelID.w ? r4.z : 0;
    r4.z = (0 != cb1[162].y) ? 1.0 : 0.0;
    r6.xyz = r4.zzz ? float3(1,1,1) : albedo_alpha.xyz;
    customData.w = customData.w ? 1 : 0;
    r6.xyz = msr_shadingModelID.www ? customData.www : r6.xyz;
    albedo_alpha.xyz = normal_perObjectData.yyy ? r6.xyz : albedo_alpha.xyz;
    normal_perObjectData.y = tex2Dlod(_IN9, float4(0, 0, 0, 0)).x;
    r4.zw = screenUV_ndcUV.zw * albedo_alpha.ww;
    r6.xyz = cb1[49].xyz * r4.www;
    r6.xyz = r4.zzz * cb1[48].xyz + r6.xyz;
    r6.xyz = albedo_alpha.www * cb1[50].xyz + r6.xyz;
    r6.xyz = cb1[51].xyz + r6.xyz;
    r4.zw = tex2Dlod(_IN5, float4(screenUV_ndcUV.xy, 0, 0)).xz;
    r4.zw = r4.zw * r4.zw;
    msr_shadingModelID.w = r4.z * r4.w;
    customData.w = cb1[253].y * msr_shadingModelID.w;
    if (cb1[255].x != 0) {
        r8.xyz = float3(0,0,0);
        r4.zw = float2(0,0);
        r5.w = 0;
        ...
        while (true) {
            ...
            r11.x = r11.x * r4.w + screenUV_ndcUV.x;
            r11.y = r10.x * r4.w + screenUV_ndcUV.y;
        ...
        r4.w = customData.x * -2 + 3;
        customData.x = customData.x * customData.x;
        customData.x = r4.w * customData.x;
        r4.w = -0.5 + normal_perObjectData.w;
        ...
        r8.w = msr_shadingModelID.w * cb1[253].y + -cb1[265].x;
        r7.w = 1 / r7.w;
        ...
        r8.w = r10.x * r8.w;
        r8.w = r8.w * r6.w;
        r10.x = msr_shadingModelID.w * cb1[253].y + -r8.w;
        ...
        r6.w = customData.w * r4.w + -r5.w;
        r5.w = r5.x * r6.w + r5.w;
        r6.w = customData.w * r4.w + -r4.w;
        ...
        normal_perObjectData.x = r4.z * normal_perObjectData.x + 1;
        ...
        r4.z = customData.x * -2 + 3;
        customData.x = customData.x * customData.x;
        customData.x = r4.z * customData.x;
        ...
        r4.z = r4.z * r4.z;
        r4.z = r4.w * r4.z;
        r4.w = r4.z * customData.x;
        r5.w = cb1[265].y + -cb1[265].x;
        r6.w = msr_shadingModelID.w * cb1[253].y + -cb1[265].x;
        r5.w = 1 / r5.w;
        ...
        r6.w = r7.w * r6.w;
        r6.w = r6.w * r4.w;
        msr_shadingModelID.w = msr_shadingModelID.w * cb1[253].y + -r6.w;
        msr_shadingModelID.w = cb1[265].z * msr_shadingModelID.w + r6.w;
        r6.w = -cb1[265].x + msr_shadingModelID.w;
        r5.w = saturate(r6.w * r5.w);
        r6.w = r5.w * -2 + 3;
        r5.w = r5.w * r5.w;
        r5.w = r6.w * r5.w;
        r4.w = r5.w * r4.w;
        customData.x = customData.x * r4.z + -r4.w;
        customData.x = cb1[265].z * customData.x + r4.w;
        r4.z = msr_shadingModelID.w * r5.y;
        r4.z = 10 * r4.z;
        msr_shadingModelID.w = -1 + msr_shadingModelID.w;
        msr_shadingModelID.w = cb1[260].y * msr_shadingModelID.w + 1;
        r4.w = customData.w * customData.x + -msr_shadingModelID.w;
        msr_shadingModelID.w = r5.x * r4.w + msr_shadingModelID.w;
        r4.w = customData.w * customData.x + -customData.x;
        r10.x = r5.x * r4.w + customData.x;
        r5.xyw = float3(0.200000003,0.200000003,0.200000003) * cb1[261].xyz;
        r9.xyz = cb1[262].xyz * float3(0.5,0.5,0.5) + -r5.xyw;
        r5.xyw = msr_shadingModelID.www * r9.xyz + r5.xyw;
        ...
        r8.xyz = msr_shadingModelID.www * r9.xyz + r5.xyw;
    }
    ...
    msr_shadingModelID.w = 1;
    customData.x = 0;
    while (true) {
        r4.z = ((uint)customData.x >= asuint(cb2[128].x)) ? 1.0 : 0.0;
        if (r4.z != 0) break;
        bitmask.z = ((~(-1 << 29)) << 3) & 0xffffffff;  r4.z = (((uint)customData.x << 3) & bitmask.z) | ((uint)7 & ~bitmask.z);
        bitmask.w = ((~(-1 << 3)) << 5) & 0xffffffff;  r4.w = (((uint)cb2[r4.z+0].w << 5) & bitmask.w) | ((uint)0 & ~bitmask.w);
        r4.w = (int)r4.y & (int)r4.w;
        if (r4.w == 0) {
        r4.w = (int)customData.x + 1;
        customData.x = r4.w;
        continue;
        }
        r4.w = (uint)customData.x << 3;
        ...
        r10.xyz = r11.xyz * msr_shadingModelID.www + r10.xyz;
        r4.z = -r4.w * r4.z + 1;
        msr_shadingModelID.w = r4.z * msr_shadingModelID.w;
        }
        customData.x = (int)customData.x + 1;
    }
    r4.yzw = msr_shadingModelID.www * r5.xyw + r10.xyz;
    normal_perObjectData.x = ((int)r4.x != 13) ? 1.0 : 0.0;
    if (normal_perObjectData.x != 0) {
        normal_perObjectData.x = ((int)r4.x == 1) ? 1.0 : 0.0;
        ...
        msr_shadingModelID.w = normal_perObjectData.w * 2000 + 50;
        r4.x = normal_perObjectData.w + normal_perObjectData.w;
        normal_perObjectData.x = cb0[0].x * normal_perObjectData.x;
        normal_perObjectData.x = normal_perObjectData.x * 0.800000012 + r4.x;
        ...
        customData.xyz = r4.xxx ? float3(0,0,0) : customData.xyz;
        r6.xy = r4.xx ? cb0[0].yz : cb1[264].xy;
        r6.z = r4.x ? 0.5 : cb1[264].z;
        msr_shadingModelID.xyz = r4.xxx ? r5.xyw : msr_shadingModelID.xyz;
        r4.x = dot(r6.xyz, msr_shadingModelID.xyz);
        ...
        msr_shadingModelID.z = max(0, albedo_alpha.w);
        ...
        msr_shadingModelID.xy = cb1[138].zw * msr_shadingModelID.xy;
        msr_shadingModelID.x = tex2D(_IN6, msr_shadingModelID.xy).x;
        msr_shadingModelID.y = msr_shadingModelID.x * cb1[65].x + cb1[65].y;
        msr_shadingModelID.x = msr_shadingModelID.x * cb1[65].z + -cb1[65].w;
        msr_shadingModelID.x = 1 / msr_shadingModelID.x;
        msr_shadingModelID.x = msr_shadingModelID.y + msr_shadingModelID.x;
        msr_shadingModelID.x = msr_shadingModelID.x + -albedo_alpha.w;
        ...
        msr_shadingModelID.x = 1 / msr_shadingModelID.w;
        ...
        msr_shadingModelID.xyz = customData.www * customData.xyz + msr_shadingModelID.xyz;
        ...
        normal_perObjectData.x = -10000 + albedo_alpha.w;
    ...
    albedo_alpha.xyz = r4.yzw * r7.xyz;
    albedo_alpha.xyz = cb1[263].xyz * albedo_alpha.xyz;
    albedo_alpha.xyz = albedo_alpha.xyz * float3(0.5,0.5,0.5) + -r4.yzw;
    albedo_alpha.xyz = normal_perObjectData.www * albedo_alpha.xyz + r4.yzw;
    msr_shadingModelID.xyz = r4.yzw + msr_shadingModelID.xyz;
    msr_shadingModelID.xyz = normal_perObjectData.xxx ? albedo_alpha.xyz : msr_shadingModelID.xyz;
    normal_perObjectData.xzw = normal_perObjectData.zzz ? r4.yzw : msr_shadingModelID.xyz;
