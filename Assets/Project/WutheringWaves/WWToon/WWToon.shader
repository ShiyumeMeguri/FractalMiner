...
float4 fDest = 0;
    ...
    model15_modelN16.xy = (int2)msr_shadingModelID.ww & int2(15,-16);
    msr_shadingModelID.w = ((int)model15_modelN16.x != 12) ? 1.0 : 0.0;
    ...
    msr_shadingModelID.w = msr_shadingModelID.w ? model15_modelN16.z : -1;
    if (msr_shadingModelID.w != 0) {
        ...
        msr_shadingModelID.w = dot(float2(1,1), abs(model15_modelN16.zw));
        ...
        msr_shadingModelID.w = ((int)model15_modelN16.x == 10) ? 1.0 : 0.0;
    ...
    msr_shadingModelID.w = msr_shadingModelID.w ? model15_modelN16.z : 0;
    ...
    model15_modelN16.zw = screenUV_ndcUV.zw * albedo_alpha.ww;
    ...
    msr_shadingModelID.w = model15_modelN16.z * model15_modelN16.w;
    ...
    if (cb1[255].x != 0) {
        ...
        r6.w = customData.w * model15_modelN16.w + -r5.w;
        r5.w = r5.x * r6.w + r5.w;
        r6.w = customData.w * model15_modelN16.w + -model15_modelN16.w;
        ...
        model15_modelN16.z = msr_shadingModelID.w * r5.y;
        model15_modelN16.z = 10 * model15_modelN16.z;
        msr_shadingModelID.w = -1 + msr_shadingModelID.w;
        msr_shadingModelID.w = cb1[260].y * msr_shadingModelID.w + 1;
        model15_modelN16.w = customData.w * customData.x + -msr_shadingModelID.w;
        msr_shadingModelID.w = r5.x * model15_modelN16.w + msr_shadingModelID.w;
        model15_modelN16.w = customData.w * customData.x + -customData.x;
    ...
    while (true) {
        ...
        msr_shadingModelID.w = model15_modelN16.z * msr_shadingModelID.w;
        }
        customData.x = (int)customData.x + 1;
    }
    model15_modelN16.yzw = msr_shadingModelID.www * r5.xyw + r10.xyz;
