...
float4 frag (VertexToFragment fragmentInput) : SV_Target
{
    ...
    float4 normal_perObjectData = 0, msr_shadingModelID = 0, albedo_alpha = 0, customData = 0, model_low4_high4 = 0, model13_14_15 = 0, r6 = 0, r7 = 0, r8 = 0, r9 = 0, r10 = 0, r11 = 0, r12 = 0, r13 = 0, r14 = 0, r15 = 0, r16 = 0;
...
float4 fDest = 0;
    ...
    if (shadingModelID != 0) {
        ...
        normal.xyz = normal_perObjectData.yzw * float3(2,2,2) + float3(-1,-1,-1);
        msrSq = float3(0,0,0);
        model13_14_15.xyz = float3(0,0,0);
        normal_perObjectData.xw = float2(0,0);
        customData.xy = float2(0,0);
    }
    normal_perObjectData.y = dot(normal.xyz, normal.xyz);
    normal_perObjectData.y = rsqrt(normal_perObjectData.y);
    msr_shadingModelID.xyz = normal.xyz * normal_perObjectData.yyy;
    normal_perObjectData.yz = ((int2)model_low4_high4.xx == int2(5,13)) ? 1.0 : 0.0;
    ...
    if (cb1[255].x != 0) {
        ...
        model_low4_high4.w = -0.5 + normal_perObjectData.w;
        ...
        normal_perObjectData.x = model_low4_high4.z * normal_perObjectData.x + 1;
    ...
    r9.xyz = normal_perObjectData.zzz ? model13_14_15.xyw : r14.xyz;
    model13_14_15.xyw = normal_perObjectData.zzz ? model13_14_15.xyw : r8.xyz;
    ...
    normal_perObjectData.x = ((int)model_low4_high4.x != 13) ? 1.0 : 0.0;
    if (normal_perObjectData.x != 0) {
        normal_perObjectData.x = ((int)model_low4_high4.x == 1) ? 1.0 : 0.0;
        ...
        model_low4_high4.x = normal_perObjectData.w + normal_perObjectData.w;
        normal_perObjectData.x = cb0[0].x * normal_perObjectData.x;
        normal_perObjectData.x = normal_perObjectData.x * 0.800000012 + model_low4_high4.x;
    ...
    albedo_alpha.xyz = normal_perObjectData.www * albedo_alpha.xyz + model_low4_high4.yzw;
    ...
    normal_perObjectData.xzw = normal_perObjectData.zzz ? model_low4_high4.yzw : msr_shadingModelID.xyz;
