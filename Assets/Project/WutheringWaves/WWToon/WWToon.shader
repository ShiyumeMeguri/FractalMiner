...
float4 fDest = 0;
    ...
    if (packedNormalWS_perObjectData.x != 0) {
        ...
        packedNormalWS_perObjectData.x = packedNormalWS_perObjectData.x * normal.z + customData.x;
        normal.z = checkerboardPattern * 0.5 + 0.5;
        packedNormalWS_perObjectData.x = normal.z * packedNormalWS_perObjectData.x;
        ...
        normal.xyz = normal.xyz * packedNormalWS_perObjectData.xxx;
        ...
        normal.xyz = packedNormalWS_perObjectData.xxx * normal.xyz;
    ...
    normal.xyz = packedNormalWS_perObjectData.xxx ? albedo_alpha.xyz : normal.xyz;
    packedNormalWS_perObjectData.xzw = packedNormalWS_perObjectData.zzz ? model_low4_high4.yzw : normal.xyz;
