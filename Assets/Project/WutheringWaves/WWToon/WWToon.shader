...
float4 fDest = 0;
    ...
    alpha_dynamic = albedo_alpha.w * cb1[65].x + cb1[65].y;
    albedo_alpha.w = albedo_alpha.w * cb1[65].z + -cb1[65].w;
    albedo_alpha.w = 1 / albedo_alpha.w;
    albedo_alpha.w = alpha_dynamic + albedo_alpha.w;
    ...
    if (shadingModelID != 0) {
        ...
        albedo_alpha.w = shadingModelID ? msr_shadingModelID.x : albedo_alpha.w;
